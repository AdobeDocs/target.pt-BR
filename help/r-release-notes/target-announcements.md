...
Gentry Lin, Consultor Sênior de soluções para [!DNL Adobe Target], responderá às perguntas dos clientes relacionadas às suas áreas de conhecimento:

* Implementação
* Personalização
* Fluxos de trabalho principais de criação na Web

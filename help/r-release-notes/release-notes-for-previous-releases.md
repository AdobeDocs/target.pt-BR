...
* Correção de um problema que permitia a seleção de métricas incompatíveis nas atividades Autoalocação e Público alvo automático que usam o Analytics para Público alvo (A4t). (TGT-36646)
...
* Nós padronizamos a lista de métricas disponíveis da Adobe Analytics para atividades Públicos alvos (A4T), substituindo as métricas da Adobe Analytics não suportadas na versão atual das APIs da Adobe Analytics. Isso nos permitirá estender nosso suporte A4T em futuros lançamentos de Adobe Target.
...
* Corrigido um problema que fazia com que o campo do servidor de rastreamento do Adobe Analytics ficasse em branco na página Metas e configurações para o Adobe para atividades (A4T) existentes. (TGT-35960)
...
* As Ofertas do Recommendations agora podem ser adicionadas a outros elementos que não sejam DIV (p. ex. P, UL, H1), além do DIV, em atividades de teste A/B e direcionamento de experiência. (TGT-34333)
...
* A atualização da versão 48 do Chrome introduziu um problema que faz com que o Visual Experience Composer não funcione corretamente no Chrome. O Google está buscando uma solução. Para obter mais informações, consulte [https://code.google.com/p/chromium/issues/detail?id=582603](https://code.google.com/p/chromium/issues/detail?id=582603). Para resolver este problema:
   ...
   * Ative o Enhanced Experience Composer, que pode ser configurado na guia **[!UICONTROL Configurar]** > **[!UICONTROL Preferências]**.
...
<table id="table_46FF5AF77D824ADC941B1E472234F05C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Todas as opções de configuração e edição da mbox.js agora estão disponíveis no Target Standard. Não é mais necessário fazer modificações no Target Classic. </p> <p>Consulte <a href="https://marketing.adobe.com/resources/help/pt_BR/target/ov/r_advanced_mboxjs_settings.html" format="https" scope="external">Configurações avançadas da mbox.js </a>. </p> </td> 
  </tr> 
  <tr> 
...
| Recurso | Descrição |
|---|---|
| Download da [!DNL mbox.js] do Target Standard | O arquivo da [!DNL mbox.js] agora pode ser baixado diretamente de **[!UICONTROL Configurar]** > **[!UICONTROL Implementação]** na interface do Target Standard. Anteriormente, o arquivo precisava ser baixado do Target Advanced ou ser fornecido pelo seu consultor ou representante de conta. |

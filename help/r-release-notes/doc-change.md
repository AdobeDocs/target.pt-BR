...
| Data | Tópico | Alterações |
| --- | --- | --- |
| 31 de janeiro | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Adição de informações de pré-lançamento sobre a versão 22.2.1 do [!DNL Target Standard/Premium]. |
| 28 de janeiro | [Notas de versão do Target (atual)](/help/r-release-notes/release-notes.md) | Adição de informações sobre a versão 2.8.1 da at.js. |
|  | [Detalhes da versão da at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Adição de informações sobre a versão 2.8.1 da at.js. |
| 27 de Janeiro | [Fragmentos de experiência do AEM](/help/c-experiences/c-manage-content/aem-experience-fragments.md) | Tópico atualizado e informações adicionadas sobre o [!DNL AEM as a Cloud Service] e o [!DNL Adobe I/0]. |
| 26 de Janeiro | [Notas de versão do Target (atual)](/help/r-release-notes/release-notes.md) | Adição de informações sobre a versão 22.1.2 do Target Standard/Premium. |
|  | [Criar públicos-alvo](/help/c-target/c-audiences/audiences.md) | Adição de informações sobre públicos-alvo da [!DNL Adobe Experience Platform]. |
|  | [Combinar vários públicos-alvo](/help/c-target/combining-multiple-audiences.md) | Adição de informações sobre públicos-alvo da [!DNL Adobe Experience Platform]. |
...
| 12 de janeiro | [Notas de versão do Target (atual)](/help/r-release-notes/release-notes.md) | Adição de informações sobre a versão 22.1.1 do Target Standard/Premium. |
...
| Data | Tópico | Alterações |
| --- | --- | --- |
| 11 de janeiro | [Anúncios e eventos do Target](/help/r-release-notes/target-announcements.md) | Foram adicionadas informações sobre o seguinte evento:<ul><li>[!DNL Adobe Target] Sessão de Perguntas&amp;respostas da comunidade (19 de janeiro de 2022)</li></ul> |

...
| 20º de outubro | [Notas de versão do Target (atual)](/help/r-release-notes/release-notes.md) | Foram adicionadas informações sobre a versão 21.10.4 do [!DNL Target Standard/Premium] (21 de outubro de 2021). |
|  | [Planejar e implementar o Recommendations](/help/c-recommendations/plan-implement.md) | Atualização de todo o tópico. |
| 19º de outubro | [Notas de versão do Target (atual)](/help/r-release-notes/release-notes.md) | Foram adicionadas informações sobre a versão 21.10.3 do [!DNL Target Standard/Premium] (19 de outubro de 2021). |
...
| 11º de outubro | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Foram adicionadas informações sobre a versão 21.10.2 do Target Standard/Premium (13 de outubro de 2021). |
| 6º de outubro | [Criar públicos-alvo no  [!DNL Target]](/help/c-target/c-audiences/create-audience.md) | O texto e as imagens foram atualizados para refletir a interface atualizada do [!DNL Target] [!UICONTROL Audiences]. Foram efetuadas alterações semelhantes em todos os tópicos do [!UICONTROL Audiences]. |
...
| Data | Tópico | Alterações |
| --- | --- | --- |
| 4º de outubro | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Atualização das notas de pré-lançamento da versão 21.10.1 do Target Standard/Premium (6 de outubro de 2021). |
...
|  | Visão geral ](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md#change-reporting) da [[!UICONTROL Alocação automática] | Adição das seguintes perguntas frequentes:<ul><li>Posso alterar a fonte de relatórios no meio de uma atividade de [!UICONTROL Alocação automática]?</li></ul> |
...
| Maio de 27 | [Limites](/help/r-troubleshooting-target/target-limits.md) | Adição de seção para chamadas de API do [!DNL Target]. O limite é de 50 chamadas por minuto. |
...
| Maio de 12 | [[!DNL Target] Notas de versão (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Adição de notas de pré-lançamento para o seguinte:<ul><li>SDK da Web da Adobe Experience Platform (17 de maio de 2021)</li><li>Target Standard/Premium 21.5.2</li></ul> |
| Maio de 10 | [[!DNL Recommendations] Perguntas frequentes](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md) | Adição das seguintes perguntas frequentes: &quot;Posso usar um algoritmo criado no [!DNL Adobe Recommendations Classic] no [!DNL Recommendations Premium]?&quot; |
|  | [Implementar o [!DNL Target] using [!DNL Dynamic Tag Manager] (DTM)](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/implementing-target-using-dynamic-tag-management.md) | Indicado que o [!DNL Adobe Dynamic Tag Manager] não é mais compatível. Em vez disso, o [!DNL Adobe] recomenda implementar com o [[!DNL Adobe Experience Platform Launch]](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md). |
...
| Maio de 5 | [Anúncios e eventos do Target](/help/r-release-notes/target-announcements.md) | Adição de informações sobre o intervalo da seção de perguntas e respostas da comunidade do Adobe Target, que será realizada quarta-feira, 12 de maio de 2021, às 8h (PDT, GMT-7). |
...
| Abril de 26 | [Solução de problemas na decisão no dispositivo para at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/troubleshooting-on-device-decisioning.md) | Novo tópico. |
| Abril de 19 | [Decisão no dispositivo](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/on-device-decisioning.md) | Adição dos seguinte novos artigos:<ul><li>[Decisão no dispositivo](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/on-device-decisioning.md)</li><li>[Recursos compatíveis com a decisão no dispositivo](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/supported-features.md)</li><li>[Artefato da regra de decisão no dispositivo](/help/c-implementing-target/c-implementing-target-for-client-side-web/on-device-decisioning/rule-artifact.md)</li></ul> |
...
| Abril de 9 | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Adição de informações de pré-lançamento sobre a versão 21.4.1 do Target Standard/Premium (19 de abril de 2021) |

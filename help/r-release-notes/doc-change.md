...
|  | [Privacidade](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/privacy.md#feature-usage) | Adição de uma nova seção:<ul><li>Coleta de dados de uso de recursos</li></ul> |

...
seo-description: Esta página lista alterações importantes feitas na documentação do Adobe Target.
seo-title: Alterações de documentação na documentação do produto Adobe Target.
solution: Target
...
| --- | --- | --- |
| 26 de setembro de 2019 | [Sinalização de recurso](/help/c-implementing-target/c-api-and-sdk-overview/feature-flagging.md) | Novo tópico. |
...
|  | [Target for mobile apps FAQ](/help/c-target-mobile-app/target-for-mobile-apps-faq.md) | Novo tópico. |
...
| 23 de agosto de 2019 | [Visualização do Target Mobile](/help/c-target-mobile-app/target-mobile-preview.md) | Snippet de código atualizado em `AndroidManifest.xml`. |
| 22 de agosto de 2019 | [Aplicativo para dispositivos móveis no Visual Experience Composer](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md) | Foram removidas informações sobre o uso de caracteres proibidos em IDs de aplicativos móveis. Não há mais restrições. |
|  | [Parâmetros personalizados](/help/c-target/c-audiences/c-target-rules/custom-parameters.md#considerations) | Added new section: "Considerations." |
|  | [Upload dos critérios personalizados](/help/c-recommendations/c-algorithms/recommendations-csv.md) | Atualizada a seguinte frase: Por padrão, as atualizações de critérios personalizados são "cumulativas". Os novos pares de valor-chave especificados no arquivo de upload CSV substituem os pares existentes. Existing key-value pairs that don't have keys specified in the CSV upload will still be available for delivery and will expire in 31 days from the time they are last uploaded as part of the CSV file. |
| 20 de agosto de 2019 | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Adiado o lançamento do Target/Premium 19.8.1 (20 de agosto de 2019). Content from this release will be rolled into the 19.9.1 release (September 24, 2019). |
|  | [Perguntas frequentes sobre o design](/help/c-recommendations/c-design-overview/template-faq.md) | Foram adicionadas as seguintes perguntas frequentes: "O preço do meu item recomendado não está exibindo os dois valores à direita do ponto decimal. How can I display them?" |
| 16 de agosto de 2019 | [Sincronização de perfil em tempo real para mbox3rdPartyID](/help/c-target/c-visitor-profile/3rd-party-id.md) | Added new section: "Considerations." |
|  | [Criar uma atividade do Recommendations](/help/c-recommendations/t-create-recs-activity/create-recs-activity.md) | Adição de vídeo de treinamento. |
...
| 14 de agosto de 2019 | [CNAME e Adobe Target](/help/c-implementing-target/c-considerations-before-you-implement-target/implement-cname-support-in-target.md) | Updated text and added training video link. |
...
|  | [Opções do Visual Experience Composer](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#move) | Atualizadas as informações na seção "Layout &gt; Mover". |
| 12 de agosto de 2019 | [Android - Configuração do aplicativo móvel](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md#sdk-library) | Updated information about dependencies and artifacts.<br>Updated code sample for the  file.`AndroidManifest.XML` |
|  | [Notas de versão do Target (atual)](/help/r-release-notes/release-notes.md) | Updated the list of enhancements and fixes in the "Target Mobile VEC SDK iOS 2.1.0 &amp; Android 1.1.1" section. |
|  | [Editar uma atividade ou Salvar como rascunho](/help/c-activities/edit-activity.md#classic) | Added new section: "Work with legacy activities created in Recommendations Classic." |
| 9 de agosto de 2019 | [Como a at.js funciona](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md#render) | Added new section: "How at.js renders offers with HTML content." |
|  | [Opções do Visual Experience Composer](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#considerations) | Added new section: "Considerations." |
| 7 de agosto de 2019 | [Buscar previamente conteúdo da oferta](/help/c-target-mobile-app/prefetch-offer-content.md) | Foi adicionada uma observação informando que a funcionalidade de busca prévia nos SDKs não é compatível com os tipos de atividade Destino automático, Autoalocação e Personalização automatizada. |
|  | [Solução de problemas na integração do Analytics e do Target (A4T)](/help/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/a4t-troubleshooting.md#unspecified) | Observação atualizada indicando quanto tempo o processo de classificação leva para ser concluído. |
|  | [Exibição de relatórios - Perguntas frequentes sobre o A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md#unspecified) | Observação atualizada indicando quanto tempo o processo de classificação leva para ser concluído. |
|  | [Regras de privacidade e proteção de dados](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) | Tópico atualizado para incluir informações sobre o California Consumer Privacy Act (CCPA). |
| 6 de agosto de 2019 | [Notas de versão do Target (atual)](/help/r-release-notes/release-notes.md) | Adicionadas notas de versão para a versão do Target Mobile VEC SDK iOS 2.1.0 e Android 1.1.0. |
|  | [Criar critérios](/help/c-recommendations/c-algorithms/create-new-algorithm.md#process-time) | A seguinte seção foi atualizada: "Tempo de processamento de critérios esperado." |
|  | [Exibição de relatórios - Perguntas frequentes sobre o A4T](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-viewing-reports.md#metrics) | Consideração atualizada sobre o uso das métricas Impressões [!UICONTROL de] atividade e Conversões [!UICONTROL de] atividade em [!DNL Analysis Workspace]. |
| 1 de agosto de 2019 | [Notas de versão do Target (atuais)](/help/r-release-notes/release-notes.md) | Foi adicionado um anúncio importante sobre o suporte à API para Permissões corporativas. |
|  | [Conceder acesso às integrações de E/S da Adobe para espaços de trabalho e atribuir funções](/help/administrating-target/c-user-management/property-channel/configure-adobe-io-integration.md) | Novo tópico. |
| 31 de julho de 2019 | [Introdução ao Recommendations](/help/c-recommendations/introduction-to-recommendations.md) | Novo tópico. |
|  | [Criar critérios](/help/c-recommendations/c-algorithms/create-new-algorithm.md#recently-viewed) | Added note to Recently Viewed Items. |
|  | [Problemas conhecidos e problemas resolvidos](/help/r-release-notes/known-issues-resolved-issues.md#preview) | Added known issue with Activity QA preview links. |
| 29 de julho de 2019 | [Perguntas frequentes de geração de relatórios](/help/c-reports/reporting-frequently-asked-questions.md) | Added new FAQ: "Why do my Experience Targeting (XT) reports contain metrics for control experiences?" |
| 24 de julho de 2019 | [Atualização de at.js 1.*x* para at.js 2.*x*](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) | Added new section: Cross-domain tracking support in at.js 2.x[](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#cross-domain) |
...
|  | [Recommendations como uma oferta](/help/c-recommendations/recommendations-as-an-offer.md#status) | Nova seção adicionada: "Visualizando o status da oferta de recomendações." |
|  | [Feeds](/help/c-recommendations/c-products/feeds.md) | A linha "Importando itens" foi atualizada e adicionada a linha "Feed importado com sucesso no *momento*" em Status [de feed](/help/c-recommendations/c-products/feeds.md#status). |
|  | [Pesquisa no catálogo](/help/c-recommendations/c-products/catalog-search.md) | Texto atualizado sobre como o catálogo é atualizado. |
|  | [Configurar o rastreamento de cliques no para aplicativos móveis](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | Foram adicionadas informações sobre o painel Modificações que mostra os elementos configurados para o rastreamento de cliques. |
|  | [Funcionamento do Adobe Target](/help/c-intro/how-target-works.md#bots) | Added new section: "Bots." |
|  | [Atributos do perfil](/help/c-target/c-visitor-profile/profile-parameters.md#best) | Adicionadas as práticas recomendadas para evitar a execução regex lenta. |
|  | [Aplicativo para dispositivos móveis no Visual Experience Composer](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md#ts) | Atualização da seção Solução de problemas para refletir que as restrições de caracteres não se aplicam mais aos nomes dos aplicativos. As restrições se aplicam somente a IDs. |
|  | [Feeds](/help/c-recommendations/c-products/feeds.md#steps) | Adicionadas as configurações do servidor FTP com suporte às etapas. |
|  | [Detalhes da versão da at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Adição de informações sobre a at.js 2.1.1. |
|  | [Notas de versão](/help/r-release-notes/release-notes.md): 19.7.1 | Essa versão inclui aprimoramentos e correções. Você pode ler sobre eles e acessar a documentação a partir das notas de versão. Esta versão também inclui muitas atualizações da documentação na seção de ajuda. |

## Adobe Target Standard/Premium 19.6.1 (26 de junho de 2019) {#tgt-19-6-1}

| Data | Tópico | Alterações |
| --- | --- | --- |
| 10 de julho de 2019 | [Limites](/help/r-troubleshooting-target/target-limits.md) | Foram adicionadas informações de limite para os seguintes itens:<ul><li>Número de experiências por atividade.</li><li>Número de métricas de sucesso por atividade.</li><li>Número de públicos-alvo/segmentos de relatório por atividade.</li><li>Número de públicos-alvo por mbox, métrica e experiência.</li><li>Número de valores únicos por regra de direcionamento.</li><li>Número de públicos-alvo únicos por regra de direcionamento.</li><li>Número de regras de direcionamento exclusivas por atividade.</li><li>Número de scripts de perfil ativos.</li><li>Número do total de scripts de perfil.</li><li>Número de loops totais por script de perfil.</li><li>Número de atividades ativas.</li><li>Número de atividades salvas (e não encerradas) ativas.</li><li>Número de propriedades.</li><li>Número de ofertas.</li></ul> |
|  | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Foram adicionadas informações sobre a próxima versão do Target 19.7.1 (23 de julho de 2019).<br>Observe que essas informações estão sujeitas a alterações. |
| 8 de julho de 2019 | [CNAME e Adobe Target](/help/c-implementing-target/c-considerations-before-you-implement-target/implement-cname-support-in-target.md) | Foram adicionadas informações explicando por que você deve usar o CNAME. |
| 28 de junho de 2019 | [Problemas conhecidos e problemas resolvidos](/help/r-release-notes/known-issues-resolved-issues.md#redirect)<br>[Variações de dados esperados entre o Target e o Analíticas ao usar e não usar o A4T](/help/c-integrating-target-with-mac/a4t/understanding-expected-data-variances.md)<br>[Redirecionar ofertas-A4T FAQ](/help/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-redirect-offers.md) | Foram adicionadas informações sobre um problema conhecido que está fazendo com que um número limitado de clientes use redirecionamentos com A4T para ver uma porcentagem maior das taxas de ocorrência não corrigidas. |
| 26 de junho de 2019 | [Opções do Visual Experience ](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#styles) | Foram adicionadas informações sobre a opção [!UICONTROL Fundo] em *Estilos*. |
|  | [Aplicativo de página única (SPA) no Visual Experience Composer](/help/c-experiences/spa-visual-experience-composer.md) | Foram adicionadas informações sobre a ação [!UICONTROL Clone] . |
|  | [Rastreamento de cliques](/help/c-activities/r-success-metrics/click-tracking.md) | Foram adicionadas informações sobre o painel [!UICONTROL Elementos selecionados]. |
|  | [Aplicativo de página única (SPA) no Visual Experience Composer](/help/c-experiences/spa-visual-experience-composer.md#page-delivery-settings) | Nova seção: "Configurações de entrega de página do SPA VEC". |
|  | [Selecione o controle da atividade de Personalização automatizada ou Direcionamento automático](/help/c-activities/t-automated-personalization/experience-as-control.md) | Novo tópico. |
|  | [Políticas de cookies do Google Chrome para SameSite](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/google-chrome-samesite-cookie-policies.md) | Novo tópico. |
|  | [Coleta de dados para os algoritmos de personalização do Target](/help/c-activities/t-automated-personalization/ap-data.md) | Foram adicionadas novas tabelas para explicar os atributos individuais e fornecer exemplos. |
|  | [Perguntas frequentes sobre a personalização automatizada](/help/c-activities/t-automated-personalization/automated-personalization-faq.md) | Novas perguntas frequentes adicionadas: " Posso especificar uma determinada experiência a ser usada como controle? "<br>As seguintes perguntas frequentes foram editadas: " Quais são as práticas recomendadas para configurar uma atividade de personalização automatizada? " |
|  | [Direcionamento automático](/help/c-activities/auto-target-to-optimize.md) | Novas informações e perguntas frequentes adicionadas que especificam a experiência a ser usada como controle.<br>A seção “Determinação da alocação de tráfego” foi atualizada. |
|  | [Criar uma atividade de Automated Personalization](/help/c-activities/t-automated-personalization/create-ap-activity.md) | Foi adicionada uma etapa com informações para selecionar uma experiência específica como padrão. |
...
|  | [Problemas conhecidos e problemas resolvidos](/help/r-release-notes/known-issues-resolved-issues.md) | Foram adicionadas informações sobre relatórios que não foram renderizados para atividades Direcionamento automático em certas situações. |
...
| Data | Tópico | Alterações |
| --- | --- | --- |
| 19 de junho de 2019 | [Adicionar promoções](/help/c-recommendations/t-create-recs-activity/adding-promotions.md) | Foram adicionadas informações sobre as promoções que estão sendo deduplicadas em relação a itens recomendados pelos critérios para a atividade. |
| 13 de junho de 2019 | [Relatório de atributos importantes](/help/c-reports/c-personalization-insights-reports/important-attributes-report.md) | Novas perguntas frequentes foram adicionadas: “Por que algumas ofertas/experiências com uma taxa de conversão menor estão recebendo uma quantidade maior de tráfego, comprado a outras ofertas/experiências de um certo segmento automatizado?” |
...
|  | [Navegadores compatíveis](/help/c-implementing-target/c-considerations-before-you-implement-target/supported-browsers.md) | O Microsoft Internet Explorer 11 (IE 11) foi removido da seção “Interface do Target Standard/Premium”. O Target não oferece mais suporte nem mantém compatibilidade com o IE 11. Essa alteração afeta somente a interface do usuário do Target. A entrega de conteúdo não é afetada. Essa alteração segue anúncios semelhantes feitos pelo Adobe Analytics, pela Adobe Experience Platform e pelo Adobe Audience Manager. Recomendamos que os usuários alternem para um navegador compatível. |
| 11 de junho de 2019 | [Criação da atividade](/help/c-integrating-target-with-mac/a4t/campaign-creation.md) | A nota que afirma que é desnecessário especificar um servidor de rastreamento se você estiver usando A4T foi removida. |
|  | [Atividades](/help/c-activities/activities.md) | Foi enfatizado que não é possível restaurar uma atividade excluída. Como prática recomendada, você pode arquivar uma atividade para que ela possa ser desarquivada, se necessário. |
...
| 7 de junho de 2019 | [Personalizar um design usando a Velocity](/help/c-recommendations/c-design-overview/customizing-a-template.md#default) | Nova seção adicionada: " Cenário: Crie um design padrão 4x2 do Recommendations com lógica de verificação nula. " |
...
|  | [iOS - Configuração do aplicativo móvel](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-ios.md) | Atualização do texto e dos snippets de código. |
| 6 de junho de 2019 | [adobe.target.triggerView (viewName, options) - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-triggerview-atjs-2.md) | Atualização da descrição do parâmetro `options > page`. |
|  | [Primeiros passos do administrador](/help/administrating-target/start-target.md) | Atualização de todo o artigo. |
|  | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Notas de versão preliminares da versão do Target 19.6.1. adicionadas. |
...
|  | [Conceitos-chave do Target](/help/c-intro/target-key-concepts.md) | Edições de texto secundárias. |
| 3 de junho de 2019 | [Notas de versão (atuais)](/help/r-release-notes/release-notes.md) | Informações adicionadas sobre a versão futura do at.js 2.1.0. |
|  | [Detalhes da versão da at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Informações adicionadas sobre a versão futura do at.js 2.1.0. |
|  | [Antes de implementar](/help/c-integrating-target-with-mac/a4t/before-implement.md) | Nova seção adicionada: "Registro da análise do cliente". |
|  | [Implementação do Analytics for Target](/help/c-integrating-target-with-mac/a4t/a4timplementation.md) | Etapa 7 revisada. |
|  | [adobe.target.getOffers(options) - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Linhas foram adicionadas à tabela para os seguintes nomes de campo:<ul><li>Request &gt; experienceCloud</li><li>Request &gt; experienceCloud &gt; analytics</li><li>Request &gt; experienceCloud &gt; analytics &gt; logging</li></ul> |
...
|  | [adobe.target.sendNotifications(options)](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe.target.sendnotifications-atjs-21.md) | Novo tópico. |
|  | [Atualização da at.js 1.x para at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#integrations) | Foram adicionadas informações sobre o suporte ao Adobe Opt-in na at.js 2.1.0. |
|  | [Privacidade e o Regulamento Geral sobre a Proteção de Dados](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) | As informações sobre o suporte ao Adobe Opt-in na at.js 2.1.0 foram atualizadas. |
| 31 de maio de 2019 | [Mobile](/help/c-target/c-audiences/c-target-rules/mobile.md) | Foi adicionada uma observação sobre os dispositivos de direcionamento que executam o iOS 12.2. |
|  | [Planejar e implementar o Recommendations](/help/c-recommendations/plan-implement.md) | Amostra de código atualizada. |
| 30 de maio de 2019 | [Acessar o Target na Adobe Experience Cloud](/help/c-intro/target-access-from-mac.md#doc-lang) | A documentação agora está disponível no idioma chinês simplificado. |
...
| 22 de maio de 2019 | [Aplicativo para dispositivos móveis no Visual Experience Composer](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md#video) | Adição de vídeo de treinamento. |
|  | [iOS - Configuração do aplicativo móvel](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-ios.md#tutorial) | Links adicionados aos novos tutoriais:<ul><li>Implementar a Experience Cloud em aplicativos Objetive-C para iOS</li><li>Implementar a Experience Cloud em aplicativos Swift para iOS</li></ul> |
|  | [Android - Configuração do aplicativo móvel](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md#tutorial) | Link adicionado ao novo tutorial:<ul><li>Implementar a Experience Cloud em aplicativos Android</li></ul> |
|  | [Introdução ao Target](/help/c-intro/intro.md#kit) | Um link foi adicionado ao kit de boas-vindas do Adobe Target. |
...
**Observação**: a versão do Target Standard/Premium 19.4.1 era uma de manutenção para atualizar a interface do usuário da Adobe Experience Cloud para refletir as alterações de marca e produto.

| Data | Tópico | Alterações |
| --- | --- | --- |
| 15 de maio de 2019 | [Implementação do aplicativo de página única](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/target-atjs-single-page-application.md#triggerview) | Adição de uma observação informando que você deve acionar os eventos `at-view-start` e `at-view-end`. |
| 14 de maio de 2019 | [Visual Experience Composer para aplicativos móveis](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md),<br>[Android - configurar o aplicativo móvel](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md),<br>[iOS - configurar o aplicativo móvel](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-ios.md) e<br>[Configurar o rastreamento de cliques no VEC para dispositivos móveis](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | Novos tópicos. |
|  | [Envio de dados dinâmicos em ofertas](/help/c-experiences/c-manage-content/passing-profile-attributes-to-the-html-offer.md) | Texto atualizado. |
| 13 de maio de 2019 | [Controle de qualidade da atividade ](/help/c-activities/c-activity-qa/activity-qa.md) | Adição de item à lista Considerações sobre o uso do modo de controle de qualidade em uma atividade de várias páginas. |
...
|  | [Perguntas frequentes sobre at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-atjs-faq/target-atjs-faq.md) | Novas perguntas frequentes adicionadas: "Qual doctype HTML é exigido pela at.js?" |
...
|  | [Controle de qualidade da atividade ](/help/c-activities/c-activity-qa/activity-qa.md) | Texto atualizado. |
...
|  | [Permissões de usuário empresarial](/help/administrating-target/c-user-management/property-channel/property-channel.md#faqs) | Novas perguntas frequentes adicionadas: "As conversões de rastreamento de cliques são registradas se uma página de redirecionamento e o URL da atividade pertencerem a propriedades diferentes?" |
...
|  | [Atributos da entidade](/help/c-recommendations/c-products/entity-attributes.md) | Texto atualizado da nota na variável `entity.id`. |
| 1 de maio de 2019 | [Atributos da entidade](/help/c-recommendations/c-products/entity-attributes.md) | Capitalização corrigida nos seguintes nomes de variáveis:<br>alterado `pageURL` para `pageUrl`.<br>Alterado `thumbnailURL` para `thumbnailUrl`. |
| 30 de abril de 2019 | [Opções do Visual Experience Composer](/help/c-experiences/c-visual-experience-composer/viztarget-options.md) | <ul><li>Nova seção adicionada: "Estilos".</li><li>Tabela adicionada listando tags de HTML 5 que podem ser aninhadas.</li></ul> |
|  | [Rastreamento de cliques](/help/c-activities/r-success-metrics/click-tracking.md) | Informações adicionadas sobre o recurso de caminho DOM à seção "Considerações". |
|  | [Status do feed e indicadores](/help/c-recommendations/c-products/feeds.md#section_5DDC2DECF70A42FDAFF2235E91371537) | Atualização da tabela "Status do feed". |
|  | [Trabalhar com conteúdo na biblioteca](/help/c-experiences/c-manage-content/assets-working.md) | Informações adicionadas sobre a exclusão de pastas e imagens da biblioteca de Ativos. |
...
| Data | Tópico | Alterações |
| --- | --- | --- |
| 29 de abril de 2019 | [Permissões de usuário empresarial](/help/administrating-target/c-user-management/property-channel/property-channel.md#section_31D3450ADEAE4A29963A34F8E8C19FE0) | Adição das seguintes perguntas frequentes: "Por que recebo uma mensagem de erro indicando que nenhuma propriedade está associada a essa atividade, mesmo que haja uma propriedade atribuída?" |
| 24 de abril de 2019 | [Atualização da at.js 1.x para at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#types) | Adição de uma observação à seção "Tipos de atividade". |
...
|  | [Controle de qualidade da atividade ](/help/c-activities/c-activity-qa/activity-qa.md) | Correção de pequenos erros de digitação. |
| 23 de abril de 2019 | [Notas de versão do Target (pré-lançamento)](/help/r-release-notes/target-release-notes.md) | Notas de versão atualizadas e data alterada para 30 de abril (a anterior era 29 de abril). |
| 22 de abril de 2019 | [Acessar o Target na Adobe Experience Cloud](/help/c-intro/target-access-from-mac.md) | Nova seção adicionada: "Alterar o idioma padrão da interface do usuário do Target". |
| 19 de abril de 2019 | [Relatório de Segmentos automáticos](/help/c-reports/c-personalization-insights-reports/automated-segments-report.md#section_740910A52FA646B4AC9452F98C2F5719) | Novas perguntas frequentes adicionadas: "Há alguma lógica na ordem de exibição dos atributos em um cartão de segmento?" |
...
|  | [Perguntas frequentes do Recommendations](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md) | Adição das seguintes perguntas frequentes: "Posso excluir dinamicamente uma entidade?" |
...
|  | [Funções da at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/cmp-atjs-functions.md) | Atualização do tópico para refletir as alterações impostas pela introdução da at.js 2.x.<br>Há três novas funções disponíveis para a at.js 2.x.<ul><li>adobe.target.getOffers(options)</li><li>adobe.target.applyOffers(options)</li><li>adobe.target.triggerView (viewName, options)</li></ul> |
...
<table id="table_0348AA29207D48A4BDFFA187F4F845B7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <a href="../c-activities/t-test-ab/t-test-create-ab/test-create-ab.md#task_68C8079BF9FF4625A3BD6680D554BB72" format="dita" scope="local"> Criar um teste A/B </a> </p> <p> <a href="../c-activities/t-automated-personalization/create-ap-activity.md#task_8AAF837796D74CF893CA2F88BA1491C9" format="dita" scope="local"> Criação de uma atividade de personalização automatizada </a> </p> <p> <a href="../c-activities/t-experience-target/t-xt-create/xt-create.md#task_D6B3429AC31549E1A70EDF04B3DDC765" format="dita" scope="local">Criar uma atividade de direcionamento de experiência</a> </p> <p> <a href="../c-activities/c-multivariate-testing/t-create-multivariate-test/create-multivariate-test.md#task_BF870FA60A8245AB8F0B775BE32EA710" format="dita" scope="local"> Criar um teste multivariado </a> </p> <p> <a href="../c-recommendations/t-create-recs-activity/recs-activity-settings.md#reference_3FDA8388CEEC4159949151C1829E2FBB" format="dita" scope="local"> Configurações de atividade do Recommendations </a> </p> <p> <a href="../c-activities/t-test-ab/t-test-create-ab/ab-add-experience.md#task_454646F2895242D3B92DC395A0CE1A00" format="dita" scope="local"> Adicionar experiência </a> </p> <p> <a href="../c-activities/t-test-ab/t-test-create-ab/ab-set-metrics.md#task_A04AB66007C1467DA1C21A519A5C7BEB" format="dita" scope="local">Definir métricas</a> </p>
   </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <a href="../c-implementing-target/c-considerations-before-you-implement-target/c-methods-to-get-data-into-target/methods-to-get-data-into-target.md#concept_0069C0EFB56C4700BB33F2F35C2B9B17" format="dita" scope="local">Métodos para colocar os dados no Target</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <a href="../cmp-resources-and-contact-information.md#concept_11902FAC95C64479AABE020557A7EEE4" format="dita" scope="local"> Série de webinars de Noções básicas do Target </a> </p> </td> 
...
<table id="table_F09AC99B587A4D6390B1F8AE54F5DC47"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Adição de informações e link para ajudar a planejar os Testes A/B. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> <a href="../c-recommendations/c-recommendations-faq/recommendations-faq.md#concept_EF272DE4AC6C47B19026BFBE816F5DB8" format="dita" scope="local"> Perguntas frequentes do Recommendations </a> </p> </td> 

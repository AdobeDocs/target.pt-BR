...
>[!NOTE]
>
>Novo em 2025, o [!DNL Target] introduziu uma interface de usuário atualizada e o [!UICONTROL Visual Experience Composer] (VEC). Clique nos links a seguir para saber mais:
>

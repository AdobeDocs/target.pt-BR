...
1. Clique em **[!UICONTROL Atividades]** e depois clique na atividade desejada na lista.
   ...
   A ilustração a seguir mostra a lista suspensa [!UICONTROL Tipo] com dois tipos selecionados:  [!UICONTROL A/B Test] and [!UICONTROL Experience Targeting]. Observe que os três tipos de testes A/B (Manual, [Alocação automática](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md)e [Direcionamento automático](/help/c-activities/auto-target-to-optimize.md)) são selecionados por padrão. Você pode desmarcar um ou mais tipos conforme necessário.

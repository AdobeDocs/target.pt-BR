...
Use um feed para fornecer informações que permanecerão estáticas. Se você estiver usando um arquivo CSV ou feed do Google, utilize os seguintes parâmetros:
...
Quando o feed estiver configurado e for passado para o [!DNL Recommendations], passe os parâmetros na página para itens que mudam com frequência.
...
Para obter mais informações sobre as diferenças entre as duas bibliotecas JavaScript do Target, consulte [Entendendo as bibliotecas JavaScript do Target](../c-implementing-target/c-considerations-before-you-implement-target/target-implement.md#concept_60B748DE4293488F917E8F1FA4C7E9EB).
...
Para acessar as opções de [!UICONTROL Configurações do Recommendations], abra o [!DNL Target] na [!DNL Adobe Experience Cloud] e, em seguida, clique em **[!UICONTROL Recommendations]** &gt; **[!UICONTROL Configurações]**.

---
keywords: exclusões
description: Saiba como criar exclusões no Adobe Target Recommendations para evitar que produtos ou conteúdo sejam recomendados a visitantes.
title: Como uso exclusões no Recommendations Atividade?

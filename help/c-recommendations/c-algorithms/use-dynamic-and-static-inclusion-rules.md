...
As seções a seguir listas os tipos de opções de filtragem para critérios e promoções, Filtragem dinâmica e Filtrar por valor:
...
* As regras de inclusão dinâmica fornecem recomendações ao corresponder um atributo no parâmetro de perfil de um usuário ou em uma chamada de mbox.
   ...
   Por exemplo, você pode criar uma recomendação &quot;Critérios mais populares&quot; e, em seguida, do conjunto de recomendações retornadas, filtrar qualquer, em tempo real, contra um atributo passado quando o usuário acessa uma página onde as recomendações são exibidas.
...
Os exemplos a seguir fornecerão ideias gerais sobre como você pode usar promoções dinâmicas em seus esforços de marketing:

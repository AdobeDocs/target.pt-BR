...
>[!NOTE]
>
>O recurso Uso de critérios é atualmente compatível apenas com atividades do Recommendations. As atividades de teste A/B e direcionamento de experiência (XT) não são suportadas no momento.

...
+ Administrar o Target {#administer}
   ...
   + Definir preferências {#preferences}
      + [Preferências](administrating-target/r-target-account-preferences/target-account-preferences.md)
      + [Aumento estimado na receita](administrating-target/r-target-account-preferences/estimating-lift-in-revenue.md)
   ...
   + [Definições do Scene7](administrating-target/scene7-settings.md)
...
+ Implementar o Target {#implement-target}
   ...
   + Web do lado do cliente: implementação do Target {#client-side}
      + [Visão geral: implementar o Target para Web do cliente](/help/c-implementing-target/c-implementing-target-for-client-side-web/implement-target-for-client-side-web.md)
      ...
      + [Atualização de at. js 1. x para at. js 2. x](c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md)
      ...
      + Implementação da mbox.js {#mbox-implement}
         ...
         + Entender a mbox global {#global-mbox}
            + [Entender a análise de big data global](c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/c-understanding-global-mbox/understanding-global-mbox.md)
...
+ Integração do Adobe Target à Experience Cloud {#integrate}
   + Adobe Analytics como origem de relatório do Adobe Target (A4T) {#a4t}
      + [Visão geral do A4 T](c-integrating-target-with-mac/a4t/a4t.md)
      ...
      + [Variações de dados esperadas entre o Target e o Analytics ao usar e não usar A4 T](c-integrating-target-with-mac/a4t/understanding-expected-data-variances.md)
...
+ Atividades {#activities}
   ...
   + Teste A/B{#abtest}
      ...
      + [Nove erros comuns em testes A/B e como evitá-los](c-activities/t-test-ab/common-ab-testing-pitfalls.md)
      + Criar um teste A/B {#create}
         ...
         + [Múltiplas versões de uma experiência em um teste A/B](c-activities/t-test-ab/t-test-create-ab/target-experience-to-multiple-audiences.md)
...
+ Experiências e ofertas {#experiences}
   ...
   + Visual Experience Composer (VEC) {#vec}
      ...
      + Solução de problemas do Visual Experience Composer {#troubleshoot-composer}
         ...
         + [Solução de problemas do Compositor de experiência aprimorado](c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md)

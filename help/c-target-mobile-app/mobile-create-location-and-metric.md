...
>[!NOTE]
>
>Consulte a documentação [do Mobile](https://marketing.adobe.com/resources/help/en_US/mobile/ios/c_target_methods.html) para obter uma lista de todos os métodos do Target disponíveis.

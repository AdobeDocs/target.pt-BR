...
# ![](/help/assets/premium.png) PREMIUMCriar uma atividade de Público alvo automático
...
Para criar uma atividade [!UICONTROL Público alvo automático]:
...
1. Na lista **[!UICONTROL Atividades]**, clique em **[!UICONTROL Criar atividade]** > **[!UICONTROL Teste A/B]**.
   ...
   >[!NOTE]
   >
   >Os tipos de atividades disponíveis dependem da sua conta do [!DNL Target]. Alguns tipos de atividades podem não aparecer na lista. Por exemplo, [!UICONTROL Público alvo automático] e [!UICONTROL Recommendations] são [recursos do Público alvo Premium](/help/c-intro/intro.md#premium).
   >
...
1. Defina sua alocação de tráfego.
   ...
   Escolha o método de alocação de tráfego desejado. Para criar uma atividade [!UICONTROL Público alvo automático], selecione **[!UICONTROL público alvo automático para experiências personalizadas]**.

...
description: Saiba como usar o Visual Experience Composer (VEC) no Adobe [!DNL Target] para criar sua atividade de Teste A/B de Direcionamento automático diretamente em uma página ativada para  [!DNL Target].

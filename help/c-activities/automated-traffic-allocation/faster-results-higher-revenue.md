...
description: Saiba como uma atividade de Autoalocação no Adobe Target identifica um vencedor entre duas ou mais experiências e realoca automaticamente mais tráfego para o vencedor.
title: A alocação automática de Atividades pode obter resultados mais rápidos e receita mais alta?

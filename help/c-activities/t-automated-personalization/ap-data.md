...
Observe que alguns dos valores são arredondados para o número inteiro mais próximo ou hora.
...
| Navegador - Hora do dia | A hora do dia em que o visitante acessou a atividade. | 0 a 23 |
...
| Navegador - Tipo | O tipo de navegador usado pelo visitante ao acessar a atividade. | Chromefirefoxinternet<br><br>Explorer 10<br>safariother<br> |
| Navegador - Dia da semana/Fim de semana | O status de trabalho (fim de semana, horário de trabalho ou hora gratuita de dia da semana) quando o visitante acessou a atividade. | Sábado e domingo é o fim de semana<br>até sexta-feira, 0900 para o 1800, está trabalhando timemonday<br>até sexta-feira depois de 1800, até que 0900 seja um horário de semana gratuito |
...
| Sistema operacional | O sistema operacional do dispositivo do visitante usado para acessar a atividade. | Mac oswindows<br>10<br>linuxsearch<br>botunknown<br>OS |
...
| Fontes de tráfego - URL da página de aterrissagem de referência | A primeira página que o visitante viu ao acessar seu site. | `https://www.adobe.com/experience-cloud.html` |
...
| Rede - Velocidade da conexão | A velocidade de conexão da rede quando o visitante acessou a atividade. | Broadbandcabledslmobilewirelesssatellite<br><br><br><br><br> |
...
| Dispositivo móvel - Dispositivo - Nome do modelo | O nome do modelo do dispositivo móvel que o visitante usou para acessar a atividade. | Iphone XS |

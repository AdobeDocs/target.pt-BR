...
description: Baixe um PDF interativo que descreve os diferentes tipos de atividade no Adobe Target.
title: Que tipos de Atividade estão disponíveis no Público alvo?
feature: Activities
...
Baixe um PDF interativo que descreve os diferentes tipos de atividade em [!DNL Adobe Target] (com exceção do Recommendations).
...
| Personalização automatizada (AP) | Um meio de personalizar um conjunto e ofertas (criadas ou pré-definidas, em elemento em uma única página ou em várias páginas) e entregar combinações de ofertas que funcionam melhor para atrair visitantes específicos. |
| Teste multivariado (MVT) | Um meio de exibir várias ofertas em vários elementos e depois testar as experiências únicas resultantes ao mesmo tempo contra um objetivo específico, o que ajuda a determinar qual variação de elemento é a mais bem sucedida e também revelar potencialmente quais elementos possuem o impacto mais positivo ou negativo na interação de um visitante. |
...
| Teste multivariado (MVT) | O teste ajuda a descobrir a influência relativa que elementos específicos possuem em conversão. |

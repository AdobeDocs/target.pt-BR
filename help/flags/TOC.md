...
+ Sinalizadores de integração {#integrate}
  ...
  + [Aplicativos web](guides/integrate/web-applications.md)
...
+ Critérios de público {#audience}
  ...
  + [Criar atributos de contexto](guides/audience/creating-your-context-attributes.md)
  + [Criar e usar conjuntos de regras](guides/audience/creating-and-using-rule-sets.md)
...
+ Guia de integração {#sdk-releases}
  ...
  + [Guia de integração de extensão da Web](guides/sdk-releases/web/web-extension-integration-guide.md)

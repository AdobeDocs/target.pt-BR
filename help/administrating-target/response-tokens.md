...
>[!NOTE]
>
>Os tokens de resposta estão disponíveis com a [!DNL Adobe Experience Platform Web SDK] versão 2.6.0 ou posterior (versão programada para 1º de junho de 2021) e com a at.js versão 1.1 ou posterior.

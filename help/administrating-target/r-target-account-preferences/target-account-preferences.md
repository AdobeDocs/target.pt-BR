...
description: Defina as preferências da conta para configurar o Adobe Target Standard ou o Target Premium para funcionarem corretamente com a conta.
title: Preferências
...
Para definir as preferências de conta, clique em **[!UICONTROL Configurar]** > **[!UICONTROL Preferências]**, configure as preferências conforme desejado e clique em **[!UICONTROL Enviar]**.
...
| Carregar conteúdo misto | Ative o conteúdo misto ao abrir um site usando o Enhanced Experience Composer (EEC). Ativar essa opção evita a sobrecarga extra do carregamento de recursos estáticos pelos servidores proxy do Target.<br>Essa opção é útil, por exemplo, se os cabeçalhos de Política de segurança de conteúdo (CSP) permitirem o carregamento de conteúdo misto sem o uso de servidores proxy com o EEC ativado.<br>Essa opção também é útil se o seu site HTTP tiver aumentado o tempo de carregamento no EEC, o que significa que o JavaScript, as imagens e assim por diante levam mais tempo para carregar por proxy. |
...
## Vídeo de treinamento: preferências da conta (7:33) Etiqueta ![Visão geral](/help/assets/overview.png)

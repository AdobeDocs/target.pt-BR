...
Antes do 16.3.1, o [!DNL Target] exigia uma chamada à [!DNL mbox.js] para criar a mbox global necessária para o [!DNL Adobe Target] entregar as atividades do [!DNL Target]Target, rastrear cliques e rastrear a maioria das métricas de sucesso. Esse arquivo contém as bibliotecas necessárias para todas as suas atividades. Você não precisa manter versões específicas de atividades diferentes do arquivo. A biblioteca [!DNL at.js] substitui [!DNL mbox.js] por implementações [!DNL Target].

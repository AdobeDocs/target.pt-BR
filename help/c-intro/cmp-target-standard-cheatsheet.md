...
Temos uma documentação completa sobre APIs. Consulte a documentação de [Delivery APIs, NodeJS SDK e APIs do Recommendations](/help/c-implementing-target/c-api-and-sdk-overview/api-and-sdk-overview.md).

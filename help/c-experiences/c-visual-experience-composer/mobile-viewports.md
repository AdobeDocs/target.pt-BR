...
description: Os visores móveis ajudam você a visualizar como suas atividades do Adobe [!DNL Target] se parecem em telas de vários tamanhos. Encontre uma lista de tamanhos e resoluções populares da janela de visualização do dispositivo.
...
Os visores móveis permitem que você visualize suas atividades [!DNL Adobe Target] em telas de vários tamanhos.
...
>[!NOTE]
>
> * Use visores móveis se o seu site for responsivo e os mesmos elementos na sua página de desktop forem usados na sua página móvel em uma configuração diferente. Se você tiver um site móvel separado com uma estrutura separada, como `m.mysite.com`, use uma [atividade multipáginas](/help/c-experiences/c-visual-experience-composer/multipage-activity.md#concept_277E096063E14813AC5D8EDFA1D2ED48).
   >
   >
...
1. Na seção **[!UICONTROL Configuração de janelas de visualização móvel]**, clique em **[!UICONTROL Adicionar]**.

   ![Adicionar visor](/help/c-experiences/c-visual-experience-composer/assets/viewpoert_add.png)

   Ou

   Para alterar a configuração de uma janela de visualização móvel existente, selecione essa janela e clique no ícone [!UICONTROL Edit] (lápis).
...
1. No [!UICONTROL Visual Experience Composer] (VEC), clique no ícone de engrenagem **[!UICONTROL Configurações]** e selecione **[!UICONTROL Adicionar janelas de visualização móvel]**.
   ...
   ![Opção Adicionar janelas de visualização móvel](/help/c-experiences/c-visual-experience-composer/assets/add-mobile-viewports.png)

1. Clique no ícone **[!UICONTROL Dispositivos]** e ative cada dispositivo com um visor móvel.

   ![Ativar janelas de visualização móvel](/help/c-experiences/c-visual-experience-composer/assets/mobileviewports.png)
...
### Preferências da conta no Adobe Target ![Selo de visão geral](/help/assets/overview.png)

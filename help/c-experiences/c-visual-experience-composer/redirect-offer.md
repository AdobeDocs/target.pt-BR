...
description: Use a opção Redirecionar para URL no Adobe Target quando desejar enviar o visitante para uma página diferente em vez de mostrar o conteúdo na mesma página.

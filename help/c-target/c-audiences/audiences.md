...
* [Criar um público-alvo para uma atividade específica](/help/c-target/creating-activity-only-audience.md) e direcionar
* [Combinar vários públicos](/help/c-target/combining-multiple-audiences.md#concept_A7386F1EA4394BD2AB72399C225981E5) para criar um público-alvo ad hoc
...
Se um público-alvo for [combinado com outro público](/help/c-target/combining-multiple-audiences.md) e o público-alvo combinado é usado para criar uma atividade, as informações de uso para ambos os públicos-alvo listam essa atividade recém-criada.
...
| --- | --- | --- | --- |
| Eventos/dados dos SDKs do Adobe Experience Platform | Sim | Sim | N/A |
| Eventos da at.js | Não | Sim | N/D |

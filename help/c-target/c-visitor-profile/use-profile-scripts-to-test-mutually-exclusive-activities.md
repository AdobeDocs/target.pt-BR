...
Você pode usar atributos de perfil em [!DNL Adobe Target] para configurar testes que comparam duas ou mais atividades, mas não permitem que os mesmos visitantes participem em cada atividade.

...
* As recomendações a seguir podem ajudar a limitar a complexidade do script de perfil. Os scripts de perfil podem executar um número limitado de instruções.
   ...
   * Se os scripts de perfil se tornarem muito complexos, considere usar [tokens de resposta](/help/administrating-target/response-tokens.md) em vez disso.
...
## Vídeo de treinamento: Scripts de perfil ![Selo do tutorial](/help/assets/tutorial.png)

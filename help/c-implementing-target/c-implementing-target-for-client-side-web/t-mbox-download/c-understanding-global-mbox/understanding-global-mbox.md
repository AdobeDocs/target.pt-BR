...
description: Saiba mais sobre a mbox global no Adobe Target, um nome usado para se referir à chamada única de servidor feita na parte superior de cada página da Web na implementação do Público alvo.

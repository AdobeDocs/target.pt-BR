...
description: Use a função mboxCreate() da biblioteca de JavaScript Adobe [!DNL Target] at.js para aplicar ofertas ao DIV mais próximo com o nome de classe mboxDefault. (at.js 1.x)

...
description: Saiba como a biblioteca JavaScript do Público alvo at.js funciona, incluindo diagramas do sistema para ajudá-lo a entender o fluxo de trabalho à medida que as páginas são carregadas.
title: Como funciona a biblioteca do JavaScript at.js?
feature: at.js
role: Developer
...
### Vídeo - diagrama da arquitetura do at.js 2.x
...
### Vídeo - Horário do escritório: dicas e visão geral do at.js (26 de junho de 2019)

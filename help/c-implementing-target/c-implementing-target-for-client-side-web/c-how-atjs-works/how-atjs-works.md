...
Na implementação [!DNL Target] ilustrada abaixo, as seguintes soluções [!DNL Adobe Experience Cloud] são implementadas: Analytics, Target e Audience Manager. Além disso, os seguintes serviços Experience Cloud core são implementados: [!DNL Adobe Experience Platform], [!DNL Audiences] e [!DNL Visitor ID Service].

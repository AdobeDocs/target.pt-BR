...
| Perfis e públicos (P&amp;A) | Consulte [Audiences](https://experienceleague.adobe.com/docs/core-services/interface/audiences/audience-library.html) no *Guia do Usuário dos Serviços Principais*. |

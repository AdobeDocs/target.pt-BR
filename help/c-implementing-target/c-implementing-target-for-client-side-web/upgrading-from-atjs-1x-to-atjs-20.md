...
1. Implantar o at.js 2.*x* por meio de tags em [[!DNL Adobe Experience Platform]](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md) extensão.
...
### at.js 2.*x*  não oferece suporte à criação de públicos-alvo usando vst.* parâmetros {#vst}
...
## Vídeo de treinamento: at.js 2.*x* diagrama de arquitetura ![Selo de visão geral](/help/assets/overview.png)

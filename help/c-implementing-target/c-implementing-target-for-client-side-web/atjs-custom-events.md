...
description: Use eventos personalizados para que a biblioteca JavaScript do Adobe [!DNL Target] at.js seja notificada quando uma solicitação ou oferta de mbox falhar ou for bem-sucedida.
...
| type | String | **Artefato de decisão no dispositivo**<br> succeededConstant:<br>`adobe.target.event.ARTIFACT_DOWNLOAD_SUCCEEDED`<br>Valor da string:  `artifactDownloadSucceeded`<br>Descrição: Chamado quando o artefato de decisão no dispositivo é baixado com êxito.<br>**O artefato de decisão no dispositivo**<br> falhouConstante:  `adobe.target.event.ARTIFACT_DOWNLOAD_FAILED`<br>Valor da string:  `artifactDownloadFailed`<br>Descrição: Chamado quando o artefato de decisão no dispositivo não pôde ser baixado. |
...
## Vídeo de treinamento: Tokens de resposta e os Eventos personalizados da at.js ![Selo tutorial](/help/assets/tutorial.png) {#section_ED304A7137DC42A4BDCD6D57C989F1FA}

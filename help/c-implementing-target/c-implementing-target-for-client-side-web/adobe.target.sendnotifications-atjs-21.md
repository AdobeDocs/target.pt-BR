...
description: Use adobe.target.sendNotifications() para at.js para enviar notificações para a borda  [!DNL Target] quando uma experiência é renderizada e não usa applyOffer(s). (at.js.2.1 +)

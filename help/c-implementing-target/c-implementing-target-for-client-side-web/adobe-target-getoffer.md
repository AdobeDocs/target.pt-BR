---
description: 'Informações sobre a função adobe. target. getoffer (opções) para at. js. '
keywords: adobe.target.notificação; elemento; seletor; notificação; extensão
seo-description: Informações sobre a função adobe. target. getoffer (opções) da biblioteca do Adobe Target no javascript.
seo-title: Informações sobre a função adobe. target. getoffer (opções) da biblioteca do Adobe Target no javascript.
solution: Target
subtopic: Introdução

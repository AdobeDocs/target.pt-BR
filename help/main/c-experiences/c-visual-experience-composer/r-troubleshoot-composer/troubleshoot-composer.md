...
description: Saiba como solucionar problemas que ocorrem no Visual Experience Composer (VEC) e no Enhanced Experience Composer (EEC) sob determinadas condições.
title: Como solucionar problemas do Visual Experience Composer e no Enhanced Experience Composer?
...
Problemas de exibição às vezes ocorrem no [!DNL Adobe Target] [!UICONTROL Visual Experience Composer] e o [!UICONTROL Enhanced Experience Composer] (CEE), sob certas condições.

...
>[!NOTE]
>
>Consulte o [Documentação da API de entrega](https://developer.adobe.com/target/before-administer/){target=_blank} para obter informações sobre os tipos aceitáveis para todos os campos listados abaixo.

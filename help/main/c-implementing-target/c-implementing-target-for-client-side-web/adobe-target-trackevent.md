...
description: Use a função adobe.target.trackEvent() para o Adobe [!DNL Target] biblioteca JavaScript da at.js para acionar uma solicitação para relatar ações do usuário, como cliques e conversões em seu site.

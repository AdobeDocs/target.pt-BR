...
description: Use a função adobe.target.getOffers() e suas opções para o Adobe [!DNL Target] biblioteca at.js para acionar solicitações para obter várias [!DNL Target] ofertas. (at.js 2.x)

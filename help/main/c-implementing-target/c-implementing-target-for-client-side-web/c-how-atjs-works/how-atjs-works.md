...
description: Saiba como a [!DNL Target] Funções da biblioteca JavaScript da at.js, incluindo diagramas de sistema para ajudar você a entender o fluxo de trabalho quando as páginas são carregadas.
...
Para implementar [!DNL Adobe Target] no cliente, você deve usar a biblioteca at.js de JavaScript.
...
No [!DNL Target] implementação ilustrada abaixo, o seguinte [!DNL Adobe Experience Cloud] As soluções são implementadas: Analytics, Target e Audience Manager. Além disso, os seguintes serviços Experience Cloud core são implementados: [!DNL Adobe Experience Platform], [!DNL Audiences]e [!DNL Visitor ID Service].

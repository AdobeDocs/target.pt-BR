...
1. Crie uma campanha.
   ...
   Consulte [Implementações não baseadas em JavaScript](https://developer.adobe.com/target/implement/email/) para a configuração correta para atingir seus objetivos.

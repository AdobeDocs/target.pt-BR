...
description: Obter dados em [!DNL Target] uso de atributos de perfil de script.
title: Como obter dados sobre [!DNL Target] Usando atributos de perfil de script?
...
Os atributos de perfil de script são pares de nome/valor definidos na variável [!DNL Adobe Target] solução. O valor é determinado na execução de um snippet do JavaScript no servidor Target, a cada chamada do servidor.

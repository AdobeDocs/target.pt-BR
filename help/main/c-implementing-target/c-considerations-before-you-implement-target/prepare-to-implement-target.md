...
description: Saiba as considerações que você deve abordar antes de implementar o Adobe Target. Conclua as tarefas necessárias e colete as informações ao preparar-se para implementar o Target.
...
## Adobe [!DNL Target] solicitação de informações de negócios {#section_A345E8D9ED41478A90ABE7703648C06C}
...
Baixe o documento de [Solicitação de informações de negócios](/help/main/assets/business-rfi.docx).

## Adobe [!DNL Target] pedido técnico de informações {#section_95C4F0A2E4EB423399D24F2B7198F6C5}
...
Baixe o documento de [Solicitação de informações técnicas](/help/main/assets/technical-rfi.docx).

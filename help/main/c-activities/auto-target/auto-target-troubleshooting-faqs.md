...
### O Adobe que você recomenda usar [!UICONTROL Direcionamento automático] com uma divisão de 90(Controle)/10(Direcionado) até que os modelos sejam criados?

+++Responda A divisão de alocação de tráfego ideal depende do que você deseja realizar.

Se o objetivo for personalizar o máximo de tráfego possível, você poderá manter a alocação direcionada de 90% e o controle de 10% durante todo o tempo de vida útil da atividade. Se o objetivo for executar um experimento comparando o desempenho dos algoritmos personalizados com o controle, uma divisão 50/50 é melhor para o tempo de vida da atividade.
...
+++Resposta
[!UICONTROL Direcionamento automático] O pode ser usado como personalização &quot;sempre ativa&quot; que otimizará constantemente. Especialmente para conteúdo permanente, não há necessidade de interromper sua atividade de [!UICONTROL Direcionamento automático].
...
* Depois que uma atividade está ativa, [!UICONTROL Direcionamento automático] considera até os últimos 45 dias de dados fornecidos aleatoriamente ao tentar criar modelos (por exemplo, controlar o tráfego, além de alguns dados adicionais fornecidos aleatoriamente e retidos pelo algoritmo).
...
+++Resposta Você pode começar a ver os resultados de seus [!UICONTROL Direcionamento automático] teste depois de ter pelo menos duas experiências com modelos construídos (marca de seleção verde) para a experiência que os modelos construíram.
...
+++Adobe de resposta não recomenda que você altere a métrica de meta durante uma atividade. Embora seja possível alterar a métrica de meta durante uma atividade utilizando a interface do usuário [!DNL Target], você sempre deve iniciar uma nova atividade. Não garantimos o que pode acontece se você alterar a métrica de meta em uma atividade após sua execução.
...
+++Resposta
[!DNL Target] O cria um modelo por experiência, portanto, remover uma experiência significa [!DNL Target] O cria um modelo a menos e não afetará os modelos das outras experiências.

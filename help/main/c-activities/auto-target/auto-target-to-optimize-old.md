...
* [!UICONTROL Avaliar Algoritmo Personalization]
* [!UICONTROL Maximizar o tráfego do Personalization]
...
Para ajustar a porcentagem de [!UICONTROL Controle], clique nos ícones na coluna [!UICONTROL Alocação]. Você não pode diminuir o grupo de controle para menos de 10%.
...
* Comparar e contrastar [!UICONTROL Direcionamento automático] para [!UICONTROL Automated Personalization]

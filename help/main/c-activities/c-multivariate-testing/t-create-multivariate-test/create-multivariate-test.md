...
description: Saiba como usar o Visual Experience Composer (VEC) no Adobe [!DNL Target] para criar um teste multivariado (MVT) diretamente em um [!DNL Target]página habilitada para.

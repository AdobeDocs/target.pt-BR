...
# Visualizar experiências em atividades do [!UICONTROL Automated Personalization] no [!UICONTROL Visual Experience Composer] (VEC)
...
1. Clique em **[!UICONTROL Compor]** para retornar para o [!UICONTROL Visual Experience Composer] e fazer quaisquer alterações adicionais, ou clique em **[!UICONTROL Avançar]** para ir para a etapa [!UICONTROL Direcionamento].

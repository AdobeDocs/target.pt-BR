...
description: Gerenciar exclusões nas atividades de  [!DNL Adobe Target] [!UICONTROL Automated Personalization] (AP). Crie grupos de exclusão e exclua ofertas duplicadas, experiências específicas e conteúdo padrão.
title: Como gerenciar exclusões nas atividades do [!UICONTROL Automated Personalization]?
...
Gerencie exclusões criando grupos de exclusão e excluindo ofertas duplicadas, experiências específicas e o conteúdo padrão nas atividades do [!UICONTROL Automated Personalization] (AP) em [!DNL Adobe Target].

## Criar grupos de exclusão {#task_AAAA6C7239A84F7696C8492F04B575A2}

Crie grupos de exclusão em atividades do [!UICONTROL Automated Personalization] (AP) para garantir que as experiências com as ofertas designadas sejam excluídas automaticamente.
...
1. Na caixa de diálogo [!UICONTROL Gerenciar conteúdo], clique em **[!UICONTROL Grupos de Exclusão]**.
...
Clique na opção de engrenagem **[!UICONTROL Configurar]** > **[!UICONTROL Duplicar Ofertas]** e clique em **[!UICONTROL Permitir Duplicatas]** ou **[!UICONTROL Não Permitir Duplicatas]**.
...
Exclua experiências específicas se quiser excluir determinadas combinações de ofertas da atividade do [!UICONTROL Automated Personalization].
...
1. Exclua as experiências, conforme desejado.
   ...
   Ou você pode excluir experiências em lote marcando a caixa de seleção das experiências relevantes e, em seguida, clicando no ícone **[!UICONTROL Excluir]** no canto superior direito da caixa de diálogo. O ícone [!UICONTROL Excluir] é exibido quando uma ou mais experiências são verificadas.
   ...
   As experiências agora são excluídas da atividade e seu [!UICONTROL Status] é exibido como [!UICONTROL Excluídos].
...
1. Ao [criar ou editar uma atividade de AP](/help/main/c-activities/t-automated-personalization/create-ap-activity.md), selecione o conteúdo que deseja substituir e clique para acessar **[!UICONTROL Alterar Texto/HTML]**, **[!UICONTROL Alterar Imagem]** ou **[!UICONTROL Alterar Cor de Fundo]**.
1. Na caixa de diálogo, crie seu novo conteúdo e desmarque **Incluir** à direita do conteúdo padrão (ou desmarque Imagem/Vídeo padrão na tela [!UICONTROL Selecionar conteúdo]).

   Dependendo do tipo de conteúdo ou oferta, a caixa de seleção [!UICONTROL Incluir] está em um local um pouco diferente.
...
1. Clique em **[!UICONTROL Salvar]**.
   ...
   Você pode visualizar as experiências criadas nas ofertas que especificou em [!UICONTROL Gerenciar conteúdo]. Você observou que nenhuma experiência foi criada em [!UICONTROL Gerenciar conteúdo] usando a oferta padrão excluída.

   ![excluir_conteúdo_vec_4 imagem](assets/exclude_content_vec_4.png)

**Para excluir o conteúdo padrão usando o [!UICONTROL Experience Composer baseado em formulário]:**
...
1. Na caixa de diálogo, crie seu novo conteúdo e desmarque **[!UICONTROL Incluir]** à direita do conteúdo padrão (ou desmarque Imagem/Vídeo padrão na tela [!UICONTROL Selecionar conteúdo]).

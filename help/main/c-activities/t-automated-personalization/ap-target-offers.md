...
1. Depois de configurar as ofertas para a atividade no [!UICONTROL Visual Experience Composer], clique no ícone **[!UICONTROL Gerenciar conteúdo]** ( ![ícone Gerenciar conteúdo](/help/main/assets/icons/Experience.svg) ).
...
1. Selecione as ofertas desejadas e escolha os públicos que deseja qualificar para ver essa oferta.
   ...
   Para configurar o direcionamento para uma única oferta, clique no ícone Mais Informações ( ![Mais Informações](/help/main/assets/icons/MoreSmallList.svg) ) ao lado da oferta desejada e, em seguida, clique em **[!UICONTROL Público-Alvo]** para exibir a caixa de diálogo [!UICONTROL Adicionar Públicos-Alvo].

   Para configurar o direcionamento para várias ofertas, marque as caixas de seleção para as ofertas desejadas e clique no link **[!UICONTROL Público-alvo]**, que é exibido na parte inferior da lista.

1. Na caixa de diálogo [!UICONTROL Adicionar Públicos-alvo], selecione os públicos-alvo desejados para as ofertas e clique em **[!UICONTROL Atribuir Público-alvo]** para retornar à caixa de diálogo [!UICONTROL Gerenciar Conteúdo].

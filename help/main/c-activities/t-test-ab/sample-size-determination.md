...
Um sucesso [!UICONTROL Teste A/B] atividade em [!DNL Adobe Target] O requer visitantes suficientes (tamanho da amostra) para melhorar sua taxa de conversão. Como você sabe por quanto tempo executar um teste A/B? Este artigo contém informações sobre [!UICONTROL Alocação automática] e [!UICONTROL Adobe Target] Calculadora de tamanho de amostra para ajudar você a garantir que sua atividade tenha visitantes suficientes para atingir suas metas.
...
Um [Alocação automática](/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) é um tipo de teste A/B que identifica um vencedor entre duas ou mais experiências. Um teste de Alocação automática realoca automaticamente mais tráfego para o vencedor a fim de aumentar as conversões enquanto o teste continua a ser executado e aprendido.
...
Ao usar um [!UICONTROL Alocação automática] atividade , [!DNL Target] identifica um vencedor entre duas ou mais experiências e realoca automaticamente mais tráfego para o vencedor a fim de aumentar as conversões enquanto o teste continua a ser executado e aprendido. [!UICONTROL A alocação automática facilita a conquista das metas de conversão, além de remover a adivinhação.]

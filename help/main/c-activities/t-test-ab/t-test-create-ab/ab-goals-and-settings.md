...
| [!UICONTROL Metodologia Estatística] | Escolha como os resultados do experimento são analisados. Esta opção determina a estrutura estatística, as métricas de resultados e os critérios de decisão usados para a métrica de meta [!UICONTROL Conversão] desta atividade:<ul><li>**[!UICONTROL Bayesiano]**: decisão baseada em probabilidade que atualiza crenças conforme os dados chegam e oferece suporte ao monitoramento contínuo e tamanhos de amostra menores. Os resultados são expressos como a probabilidade de uma variante ser melhor que outra, por exemplo &quot;92% de probabilidade de a Variante B vencer o Controle&quot;. [!UICONTROL Bayesiano] é mais adequado para amostras menores, monitoramento contínuo, participantes que preferem probabilidades ou quando você tem conhecimento prévio de testes anteriores para aplicar. Não é ideal quando você precisa de aprovação normativa ou de conformidade rígida, ou precisa de valores p tradicionais. Os relatórios mostram [!UICONTROL Chance de Superar o Controle] e um intervalo de credibilidade em vez da coluna [!UICONTROL Confidence] frequencista.</li><li>**[!UICONTROL Teste t de Welch (Frequentista)]**: a metodologia tradicional existente de teste de hipótese. Usa valores p e requer um tamanho de amostra fixo. Os relatórios mostram uma porcentagem de [!UICONTROL Confiança] e um intervalo de confiança.</li></ul>Esta configuração só está disponível para atividades cuja métrica de meta principal seja [!UICONTROL Conversão], atividades com uma [!UICONTROL Receita] ou [!UICONTROL Envolvimento] meta principal sempre usam o [!UICONTROL teste t de Welch]. Para obter mais informações sobre como cada metodologia é calculada e relatada, consulte [Cálculos estatísticos em testes A/Bn](/help/main/c-reports/statistical-methodology/statistical-calculations.md). |
| [!UICONTROL Configuração Bayesiana] | Exibido somente quando [!UICONTROL Bayesiano] é selecionado como a [!UICONTROL Metodologia Estatística]. Configure as seguintes opções:<ul><li>[!UICONTROL Intervalo de Credibilidade]: Define o intervalo no qual se espera que o efeito verdadeiro caia.</li><li>[!UICONTROL Limite de Decisão]: define a probabilidade mínima que uma variante deve atingir, relativa a [!UICONTROL Controle], antes de ser declarada vencedora. </li><li>[!UICONTROL Usar conhecimento anterior de testes anteriores?]: Ative esta opção para fornecer conhecimento anterior de desempenho anterior para informar o cálculo [!UICONTROL Bayesiano].</li></ul> |


## Configurações avançadas {#section_E2FE441AFB324E498793ABB025ED9974}

A seção [!UICONTROL Configurações Avançadas] da página [!UICONTROL Metas e Configurações] permite configurar as opções avançadas.

Para especificar configurações avançadas, clique no ícone **[!UICONTROL Mais]** ( ![ícone de Mais](/help/main/assets/icons/MoreSmallList.svg) ) na seção [!UICONTROL Minha Meta Primária] e clique em **[!UICONTROL Configurações Avançadas]**.

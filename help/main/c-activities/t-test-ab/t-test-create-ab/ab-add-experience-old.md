---
keywords: Direcionamento; experiência; adicionar experiência; adicionar experiência
...
1. Na página **[!UICONTROL Experiências]** do VEC, clique em **[!UICONTROL Adicionar experiência]**.
...
1. Clique em **[!UICONTROL Salvar]** quando terminar de criar a experiência.

## Renomear experiência

1. Clique no ícone **[!UICONTROL Renomear experiência]** em uma experiência de uma atividade de [!UICONTROL Teste A/B] ou [!UICONTROL Direcionamento de experiência] (XT) para dar um novo nome à experiência.
...
1. Clique no ícone **[!UICONTROL Mais]** (as reticências verticais) em uma experiência de uma atividade de [!UICONTROL Teste A/B] ou [!UICONTROL Direcionamento de experiência] (XT) e clique em **[!UICONTROL Redirecionar para a URL]**.
...
Você pode copiar uma experiência em um [!UICONTROL Teste A/B] para fazer pequenas alterações nele sem ter que recriar a experiência do zero.

1. Na página **[!UICONTROL Experiências]** (a primeira etapa do fluxo de trabalho guiado de três etapas), clique no ícone de reticências verticais > **[!UICONTROL Duplicar]**.
...
O vídeo abaixo fornece informações sobre o uso das opções do [!UICONTROL Visual Experience Composer]. (7:17)

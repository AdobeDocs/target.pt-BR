...
| Ícone do [!UICONTROL Show filters]<P>![Ícone Mostrar Filtros](/help/main/assets/icons/Filter.svg) | Acesse filtros clicando no ícone **[!UICONTROL Show Filters]** próximo à parte superior da lista para filtrar as atividades por [!UICONTROL Type], [!UICONTROL Status], [!UICONTROL Reporting Source], [!UICONTROL Experience Composer], [!UICONTROL Metrics Type], [!UICONTROL Activity Source] e [!UICONTROL Properties].<P>Para obter mais informações, consulte [Aplicar filtros à lista de Atividades](#filters) abaixo. |
| Pesquisar campos | Localize rapidamente uma atividade ou reduza o número de atividades exibidas na lista [!UICONTROL Activity]. Você pode pesquisar por [!UICONTROL Activity Name], [!UICONTROL URL] ou [!UICONTROL ID]. |

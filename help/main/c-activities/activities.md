...
| [!UICONTROL Status] | Filtrar por status de atividade.<ul><li>**[!UICONTROL Live]**: a atividade está em execução no momento.</li><li>**[!UICONTROL Scheduled]**: A atividade está pronta para ser ativada na data e hora de início especificadas.</li><li>**[!UICONTROL Inactive]**: a atividade foi pausada ou desativada.</li><li>**[!UICONTROL Ended]**: A data e hora de término especificadas foram atingidas e a atividade não está mais sendo veiculada.</li><li>**[!UICONTROL Archived]**: A atividade foi arquivada. Você pode ativar uma atividade arquivada para usá-la novamente.</li></ul>Consulte a observação abaixo nesta tabela para obter mais informações sobre os status obsoletos [!UICONTROL Save as Draft] e [!UICONTROL Syncing]. |
...
>[!NOTE]
>
>**Atualização nos estados de atividade na interface atualizada**: com as atualizações mais recentes da interface do usuário, os estados [!UICONTROL Save as Draft] e [!UICONTROL Syncing] não estão mais disponíveis. Isso ocorre porque toda a criação e edição de atividades agora ocorre diretamente no sistema de entrega [!DNL Target] de back-end usando a camada do GraphQL, garantindo um processo mais simplificado e eficiente.
>
...
>
>[!DNL Adobe] entende que alguns clientes expressaram interesse no recurso [!UICONTROL Save as Draft]. Embora agradecemos esse feedback, essa funcionalidade não é compatível no momento.

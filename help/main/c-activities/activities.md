...
description: Saiba mais sobre atividades no Adobe [!DNL Target] As permitem personalizar o conteúdo para públicos específicos e testar designs de página.
...
>[!NOTE]
>
>A ilustração e a tabela a seguir mostram a funcionalidade da interface atualizada da lista de Atividades atualmente na versão beta, que será lançada em breve.
...
| [!UICONTROL Excluir] | Exclui um rascunho ou atividade.<P>**OBSERVAÇÃO**: não é possível recuperar as atividades excluídas. A menos que você tenha certeza de que nunca precisará dessa atividade novamente, use o [!UICONTROL Arquivar] ação. Se necessário, é possível reativar a atividade. |
...
| Públicos-alvo e localizações | 50 as combinações de públicos-alvo e localizações (mbox) não devem ser maiores que 50. |

...
![Página Configurações da atividade](/help/main/c-activities/t-experience-target/t-xt-create/assets/ab_settings-new.png)
...
Se esta opção não estiver ativada na Administração (padrão), especifique uma prioridade: baixa, média ou alta.

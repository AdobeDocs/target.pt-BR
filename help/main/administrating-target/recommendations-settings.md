...
Para acessar as opções de configurações de [!DNL Recommendations], abra [!DNL Target] no [!DNL Adobe Experience Cloud] e clique em [!UICONTROL Administração] > [!UICONTROL Recomendações].

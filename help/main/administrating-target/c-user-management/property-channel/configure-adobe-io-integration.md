...
# ![PREMIUM](/help/main/assets/premium.png) Conceder acesso às integrações do Adobe I/O para espaços de trabalho e atribuir funções
...
Com o [!DNL Target] Versão de setembro de 2019, [!DNL Target] [!UICONTROL Permissões empresariais] O fornece aos clientes os seguintes controles de acesso:

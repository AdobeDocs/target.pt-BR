...
As permissões de usuários corporativos são um meio de administrar formalmente o acesso de usuários corporativos ao [!DNL Adobe Target]. Adicionar usuários ao [!DNL Target], atribua permissões com base em suas funções e crie espaços de trabalho para equipes com base em diferentes departamentos, localidades globais, canais e outros agrupamentos lógicos. É possível atribuir aos usuários as funções de [!UICONTROL Observador], [!UICONTROL Editor]ou [!UICONTROL Aprovador].
...
>
>Seu [!DNL Target] a implementação pode usar qualquer versão da at.js.

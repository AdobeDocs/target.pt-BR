...
Depois de receber o convite para entrar no [!DNL Adobe Experience Cloud], aceite-o, faça logon e aceite o [!UICONTROL Contrato de Licença de Usuário Final] (EULA).
...
1. Aceite os [!UICONTROL Termos de Uso].
1. Revise o resumo do que você fez até agora e clique em **[!UICONTROL Continuar para a Experience Cloud]**.
1. Entre no [!DNL Adobe Experience Cloud] e clique em **[!UICONTROL Vincular Conta]**.

   >[!NOTE]
   >
   >Caso não vincule sua conta, não será possível acessar o [!DNL Target].

   Todos os produtos da [!UICONTROL Experience Cloud] aparecem na página de vinculação. Clique em `Link Target` e digite seu nome de usuário e senha [!DNL Target] para acessar [!DNL Target].
...
Depois de aceitar o convite para entrar no [!DNL Adobe Experience Cloud] e fazer logon, confirme se [!DNL Target] foi adicionado à sua conta do [!DNL Experience Cloud] e atribua a si mesmo a função de [!UICONTROL Aprovador] para [!DNL Target].
...
## Permissões necessárias para editar configurações de [!UICONTROL Administração] {#admin-permissions}

**Antes de 22 de abril de 2025**: os usuários com direitos de [!UICONTROL Aprovadores] no [!DNL Adobe Admin Console] podem editar ou alterar todas as configurações na página [[!UICONTROL Administração]](/help/main/administrating-target/administrating-target.md) do [!DNL Target], independentemente de sua função no [!DNL Target].

**A partir de 22 de abril de 2025**: somente administradores do [!UICONTROL Produto] e das [!UICONTROL Soluções] poderão atualizar as configurações nas seções de [[!UICONTROL Administração]](/help/main/administrating-target/administrating-target.md), independentemente de suas funções nos espaços de trabalho do [!DNL Target]. Os usuários sem esta permissão terão acesso somente leitura às seções [!UICONTROL Administração].

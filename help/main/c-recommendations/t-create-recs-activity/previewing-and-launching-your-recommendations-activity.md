...
A ilustração a seguir descreve o status em um [!UICONTROL A/B Test] ou XT da atividade [!UICONTROL Overview] página:
...
Observe que o status se torna [!UICONTROL Activating]:

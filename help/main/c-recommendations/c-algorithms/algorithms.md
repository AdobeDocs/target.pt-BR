...
O tipo de algoritmo selecionado determina os algoritmos disponíveis. Há vários tipos de algoritmos, que são representados como cartões de critérios quando você configura um [!DNL Recommendations] atividade .
...
1. No [Algoritmo recomendado](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#rec-algo) seção , selecione **[!UICONTROL Item Baseado]** do **[!UICONTROL Tipo de algoritmo]** lista.

1. Selecionar **[!UICONTROL Pessoas que visualizaram isto, viram aquilo]** do **[!UICONTROL Algoritmo]** lista.

1. Selecione seu atributo de perfil personalizado no **[!UICONTROL Chave de recomendação]** list (por exemplo, [!UICONTROL Último programa adicionado à Lista de favoritos]).
...
![Guia Uso de algoritmo](/help/main/c-recommendations/c-algorithms/assets/criteria_usage.png)

>[!NOTE]
>
>O [!UICONTROL Uso de algoritmo] No momento, o recurso é compatível somente com atividades do Recommendations. No momento, esse recurso não é compatível com atividades de Teste A/B, Alocação automática, Direcionamento automático e Direcionamento de experiência (XT) que incluem [recomendações como uma oferta](/help/main/c-recommendations/recommendations-as-an-offer.md).

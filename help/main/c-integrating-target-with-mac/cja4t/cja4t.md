...
1. Entrada [!DNL Customer Journey Analytics], no **[!UICONTROL Connections]** clique em **[!UICONTROL Create a new connection]**.
   ...
   ![Criar novo link de conexão no [!DNL Customer Journey Analytics]](/help/main/c-integrating-target-with-mac/cja4t/assets/create-connection.png)

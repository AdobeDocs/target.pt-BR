...
1. Defina suas [configurações de conexão e dados](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-connections/overview){target=_blank} com as informações corretas, incluindo a mesma sandbox [!DNL Adobe Experience Platform] selecionada para a atividade.

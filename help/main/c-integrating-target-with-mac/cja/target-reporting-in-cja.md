...
description: Uso [!DNL Target] relatórios no [!DNL Adobe Customer Journey Analytics] para criar atividades com base em [!DNL Customer Journey Analytics] métricas de conversão e segmentos de público-alvo e usar [!DNL Customer Journey Analytics] relatórios para examinar os resultados.
...
# [!DNL Target] relatórios no [!DNL Adobe Customer Journey Analytics]
...
Considere as informações a seguir antes de usar o [!DNL Customer Journey Analytics] e [!DNL Target] integração:

>[!IMPORTANT]
>
>Essa integração não é a mesma que [[!UICONTROL Adobe Analytics for Target]](/help/main/c-integrating-target-with-mac/a4t/a4t.md) (A4T). A implementação e os tipos de atividade compatíveis são diferentes. Leia este artigo atentamente antes de usar essa integração para o seu [!DNL Target] atividades.
...
* Para criar [!DNL Target] atividades com [!DNL Customer Journey Analytics] relatórios, você deve ter a opção &quot;[!UICONTROL Approver]&quot; ou &#39;[!UICONTROL Editor]&quot; função no [!DNL Target].
...
* Qualquer existente [!DNL Target] As atividades do continuam a usar [!DNL Target] coleção de dados e não são afetados pela habilitação dessa integração.
* Para usar essa integração, o método de implementação preferido é ter [[!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/en/docs/experience-platform){target=_blank} and [!DNL Target] implemented through the [[!DNL Adobe Experience Platform Web SDK]](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/aep-web-sdk){target=_blank}.
  ...
  Se, atualmente, você não tiver o [!DNL Adobe Experience Platform Web SDK] implementado, você também pode criar um [[!DNL Adobe Analytics] conexão de origem](https://experienceleague.adobe.com/en/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics) para trazer os dados para [!DNL Adobe Experience Platform]. Se você planeja usar esse método, selecione um [!DNL Analytics] conjunto de relatórios junto com o [!DNL Adobe Experience Platform] sandbox usada com [!DNL Customer Journey Analytics].

  ![Opção de sandbox na caixa de diálogo Configurações de relatórios](/help/main/c-integrating-target-with-mac/cja/assets/aep-sandbox.png)

  >[!NOTE]
  >
  >Se você usar um [!DNL Adobe Analytics] conexão de origem, você terá relatórios em ambos [!DNL Adobe Analytics] e [!DNL Customer Journey Analytics]. No entanto, devido a algoritmos diferentes entre essas duas soluções, os resultados provavelmente não serão correspondentes.
...
1. Entrada [!DNL Customer Journey Analytics], no **[!UICONTROL Connections]** clique em **[!UICONTROL Create a new connection]**.

   ![Criar novo link de conexão no [!DNL Customer Journey Analytics]](/help/main/c-integrating-target-with-mac/cja/assets/create-connection.png)
...
1. Adicione o **[!UICONTROL Adobe Target Classification Events]** pesquisar conjunto de dados e, em seguida, clique em **[!UICONTROL Next]**.
...
1. Configure o conjunto de dados do evento.
   ...
   Para obter mais informações, consulte [Adicionar e configurar conjuntos de dados](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-connections/create-connection#add-dataset){target=_blank} in *Criar uma conexão* no *[!DNL Adobe Customer Journey Analytics]Guia*.

1. Configure seu conjunto de dados de pesquisa com o [!UICONTROL Key] como &quot;chave&quot; e a variável [!UICONTROL Matching] campo de chave com o seguinte caminho:
...
1. Clique em **[!UICONTROL Add datasets]** e, em seguida, clique em **[!UICONTROL Save]** na próxima tela para concluir a conexão.
...
1. Para usar [!DNL Target] dimensões na [!UICONTROL Experimentation] , configure os seguintes rótulos de contexto:
...
1. Termine de configurar outros campos e clique em **[!UICONTROL Save and continue]** quando terminar.

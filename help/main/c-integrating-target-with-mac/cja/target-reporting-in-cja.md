...
* Para perguntas sobre tempo, consulte [Considerações sobre latência](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-faq#latency){target=_blank} nas *perguntas frequentes* do Guia do *[!DNL Adobe Customer Analytics]*.

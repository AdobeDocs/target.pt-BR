...
Consulte [Implementar o Serviço de ID de Experience Cloud para o Target](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-target.html) na documentação do *Serviço de ID de visitante de Experience Cloud*.
...
Para migração, consulte [Migração para o AppMeasurement para o JavaScript](https://experienceleague.adobe.com/docs/analytics/implementation/js/migrate-from-hcode.html) no *Guia de Implementação do Analytics*.

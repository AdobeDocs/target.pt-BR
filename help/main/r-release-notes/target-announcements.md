...
## Sessão de Perguntas e respostas da comunidade do Adobe Target

* **Perguntas de acompanhamento do webinário do Recommendations de alto desempenho (Parte 2 da série de maturidade de personalização)**
* **quinta-feira, 28 de fevereiro de 2024**
* **Das 08:00 às 09:00 (PST, GMT – 8)**
* **[Informações de registro](https://experienceleaguecommunities.adobe.com/t5/target-community-events/at-community-q-amp-a-coffee-break-wednesday-2-28-24-8am-pt-high/ec-p/647204/thread-id/123){target=_blank}**

+++Detalhes

Ingressar [!DNL Adobe Target] Os especialistas Cristinel Anastasoaie, Brent Kostak e Timothy Furlow (especialista no Recommendations do Target e gerente sênior de personalização e otimização na Lenovo) respondem em tempo real às perguntas dos clientes relacionadas ao conteúdo coberto durante a [A parte 2 do [!DNL Adobe Target] Série de webinários sobre o &quot;Recommendations de alto desempenho&quot;](#maturity-series),&quot; onde nossos especialistas abordaram os seguintes tópicos:

* Recursos mais avançados que liberam recomendações adaptáveis e de maior precisão à medida que o cliente desenvolve um relacionamento com sua marca.
* Como um usuário ou profissional de marketing não técnico tem controle total sobre a configuração e o gerenciamento dos algoritmos.
* Como usar IA e recursos personalizados com recomendações para desbloquear casos de uso que têm enorme impacto na redução de cliques e no aumento da receita.

Se você perdeu o webinário original, [ouça a gravação](https://experienceleaguecommunities.adobe.com/t5/adobe-target-discussions/upcoming-webinar-2024-1-16-24-p1-adobe-target-personalization/td-p/639284){target=_blank}.

Registre-se na Parte 3 da Série de webinários que será lançada em 12/3/24, abrangendo &quot;[Desbloquear o Recommendations alimentado por IA](https://experienceleaguecommunities.adobe.com/t5/adobe-target-discussions/upcoming-webinar-2024-3-12-24-p3-adobe-target-personalization/m-p/639301/thread-id/3686){target=_blank}.&quot;
...
* **Como explorar a personalização alimentada por IA**
   ...
   * **10:00 às 11:00 (PST GMT - 8)**
     ...
     O [!DNL Adobe Target] promove recursos de personalização alimentados por IA em cada estágio do ciclo de vida do cliente para experiências personalizadas individuais. Da aquisição à retenção, saiba como as empresas estão obtendo insights sobre a simplificação de processos, minimização de esforços manuais e fornecimento de experiências contextuais e envolventes a clientes em grande escala.
...
### Otimização e personalização da experiência móvel para ambientes autenticados (26 de abril de 2023)

As marcas precisam oferecer experiências altamente personalizadas e relevantes com base nas necessidades e comportamentos específicos do cliente. Com perguntas sobre um futuro sem cookies para a tecnologia de marketing, os setores regulamentados buscam adotar uma estrutura de engajamento de clientes mais robusta e, ao mesmo tempo, otimizar cada interação com o cliente para oferecer a oferta e o conteúdo certos.

Como as marcas dos setores de serviços financeiros e seguros, varejo, viagens, hospedagem e telecomunicações podem adotar práticas recomendadas para otimização e personalização em ambientes autenticados? Entendendo a importância dos aplicativos móveis para o engajamento e a retenção de clientes fiéis, como as marcas podem habilitar o autoatendimento digital ou aumentar a adoção de novos recursos com experiências personalizadas?
...
[Link da gravação](https://video.tv.adobe.com/v/3418987){target=_blank}

### A Jornada para impulsionar o crescimento com personalização

Aumente a capacidade da sua organização de fornecer personalização, apresentada pelo gerente de sucesso do cliente da Adobe, Ramon Cespedes.

O relatório de analistas-chave sugere que as empresas que se sobressaem na personalização geram 40% mais receita do que suas contrapartes. Para atender à demanda por experiências novas, relevantes e altamente personalizadas a cada clique, os profissionais de marketing precisam da estrutura e da estratégia certas. Neste webinário, junte-se aos especialistas da Adobe para saber como usar a estrutura orientada por dados para criar os programas de personalização da sua organização e impulsionar o sucesso.
...
* [Link da gravação](https://video.tv.adobe.com/v/3410117){target=_blank}
...
### Construtores de habilidades do [!DNL Adobe Target] - Personalização orientada por IA e recomendações (15 de setembro de 2022) {#AI}

A automação da experimentação e personalização continua a impulsionar as maiores conversões e o ROI para equipes de marketing, engenharia e produtos. Junte-se à sessão Construtores de habilidades da [!DNL Adobe] e saiba como usar os casos de uso avançados orientados por IA do [!DNL Adobe Target] e recursos com recomendações de produto e conteúdo para manter-se à frente da concorrência e vencer em todas as experiências.

* [Link da gravação](https://video.tv.adobe.com/v/3409352/){target=_blank}
...
### [!DNL Adobe]: Insider do setor de personalização - Varejo (11 de agosto de 2022)
...
### [!DNL Adobe]: Personalização com precisão - [!DNL Adobe Analytics] e [!DNL Target] (2 de junho de 2022)
...
### City National Bank: a virada de jogo - Início e dimensionamento de um programa de personalização (9 de junho de 2022)
...
### [!DNL Adobe]: Descubra as oportunidades de otimização de alto impacto (16 de junho de 2022)
...
* [Link da gravação](https://optimization.dxfieldmarketing.adobeevents.com/){target=_blank}
  ...
  Junte-se a Kaitlin White (Gerente de marketing de produto da Adobe) enquanto compartilhamos estratégias testadas e verdadeiras para ajudar você a iniciar seu programa de personalização, incluindo:

   * Pensamento inovador para adquirir novos leads ou clientes
   * Correção do atrito do usuário para oferecer uma experiência mais intuitiva
   * Afinidade com o cliente para personalização
...
### [!DNL Adobe]: Insider do setor de personalização - Serviços financeiros e seguros (24 de maio de 2022)
...
* **[Inscreva-se para assistir a gravação do webinário](https://real-time.dxfieldmarketing.adobeevents.com/){target=_blank}**
   ...
   * Por que o desempenho da personalização e a velocidade são importantes para impulsionar um crescimento mais rápido dos negócios
   * Como as equipes podem criar estratégias de dados originais e resolver seus desafios de fragmentação de dados
...
* [Link da gravação](https://video.tv.adobe.com/v/328148){target=_blank}
  ...
  Mais do que nunca, os profissionais de marketing, os proprietários de produtos e os desenvolvedores estão sendo incumbidos de otimizar a experiência geral do cliente em sites, aplicativos e quaisquer outros lugares em que possam se conectar com seus clientes. Diversas ferramentas com silos de dados e implementações complicadas não servem.
...
### [!DNL Adobe Target] Skill Builder: bate-papo com o desenvolvedor, migre da mbox.js do [!DNL Adobe Target] para a at.js {#skill-builder}

Com a descontinuação da mbox.js em 31 de março de 2021, David Son, gerente de produto do Adobe Target, participou de um bate-papo com desenvolvedores para discutir os benefícios da migração da mbox.js para a at.js.

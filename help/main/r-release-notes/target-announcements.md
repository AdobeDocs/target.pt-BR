...
## Sessão de perguntas e respostas da [!UICONTROL Comunidade do Adobe Target]

Informações sobre os próximos Coffee Breaks:

### Acompanhamento do webinário de Disponibilidade do programa de personalização

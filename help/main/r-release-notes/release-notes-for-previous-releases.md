...
Para obter mais informações, consulte o [Documentação do Python SDK](https://developer.adobe.com/target/implement/server-side/python/){target=_blank} na [Guia do desenvolvedor do Adobe Target](https://developer.adobe.com/target/).
...
Para obter mais informações, consulte [detalhes da versão do at.js](https://developer.adobe.com/target/implement/client-side/atjs/target-atjs-versions/).
...
Para obter informações sobre esta versão e versões anteriores do at.js, consulte [Detalhes de versão do at.js](https://developer.adobe.com/target/implement/client-side/atjs/target-atjs-versions/).
...
* Usuários com permissões de Aprovador agora podem gerar e ativar tokens de autenticação da API de perfil. (TGT-24074)
   ...
   Para obter mais informações, consulte [Configurações da API de perfil](https://developer.adobe.com/target/before-implement/methods-to-get-data-into-target/profile-api-settings/).

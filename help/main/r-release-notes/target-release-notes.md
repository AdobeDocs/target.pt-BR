...
* Adição da capacidade de filtrar [!DNL Adobe Experience Manager] (AEM) [fragmentos de experiência](/help/main/c-experiences/c-manage-content/aem-experience-fragments.md) por tipo (HTML ou JSON) no [!UICONTROL Ofertas] lista. (TGT-43121)

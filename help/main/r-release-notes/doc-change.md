...
|--- |--- |--- |
| 5 de março | Notas de versão do [[!DNL Target]  (pré-lançamento)](/help/main/r-release-notes/target-release-notes.md) | Adição de informações de pré-lançamento para a versão 25.3.2 do [!DNL Target Standard/Premium]. |

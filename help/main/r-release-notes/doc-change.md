...
| 17 de maio | Anúncios e eventos do [[!DNL Adobe Target] ](/help/main/r-release-notes/target-announcements.md) | Adição de informações sobre o [!UICONTROL Comunidade Adobe Target] Perguntas e respostas na quarta-feira, 24 de maio de 2023. |
| 16 de maio | [Atributos da entidade](/help/main/c-recommendations/c-products/entity-attributes.md) | Indicado que não são permitidos &quot;espaços&quot; em `entity.id` valores. |
...
|  | [Implementação do aplicativo de página única](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/deploy-at-js/target-atjs-single-page-application.html){target=_blank} | Foram feitas as seguintes atualizações:<ul><li>Adição de uma observação após a Etapa 2 em &quot;Implementação de exibições do Adobe Target&quot;.</li><li>Atualização da Etapa 2 &quot;Executar solicitação do Target&quot; em &quot;Ordem de operações para carregamento inicial da página&quot;.</li></ul> |
| Maio de 4 | [Configurar autenticação para APIs do Adobe Target](https://experienceleague.adobe.com/docs/target-dev/developer/api/configure-authentication.html){target=_blank} | Adição de uma observação explicando a necessidade de migrar de uma credencial JWT para uma credencial OAuth de servidor para servidor. |
...
| 28 de novembro | [Visão geral da API de modelos (inclusão na lista de bloqueios)](https://experienceleague.corp.adobe.com/docs/target-dev/developer/administration/models-api/models-api.html?lang=pt-BR){target=_blank} no *Guia do desenvolvedor do Adobe Target*. | Nova API de modelos.<br>Os recursos podem ser bloqueados de algoritmos de aprendizado de máquina do [!DNL Target], impedindo que sejam usados em qualquer modelo ou atividade de [!UICONTROL Direcionamento automático] ou do [!UICONTROL Automated Personalization]. |
...
| 23 de novembro | [Antes de implementar o Analytics for Target (A4T) com a at.js](/help/main/c-integrating-target-with-mac/a4t/before-implement.md) | Atualização do link para o [Formulário de provisionamento de Integrações do Marketing Cloud](https://survey.adobe.com/jfe/form/SV_ekBHTLSoP5Zki2y){target=_blank}. |
...
| Data | Tópico | Alterações |
| --- | --- | --- |
| 30 de junho | [Guia do desenvolvedor do Adobe Target](https://experienceleague.corp.adobe.com/docs/target-dev/developer/overview.html?lang=pt-BR){target=_blank} | Lançamento do *Guia do desenvolvedor do Adobe Target* para consolidar todos os conteúdos para desenvolvedores do [!DNL Target] em um portal conveniente. O portal inclui informações sobre a implementação do [!DNL Target] e [!DNL Recommendations], SDKs do [!DNL Target] e APIs do [!DNL Target]. |
...
|  | [Detalhes da versão da at.js](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html?lang=pt-BR){target=_blank} | Adição de informações sobre a versão 2.9.0 da at.js. |
|  | [User-agent e Client Hints](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/user-agent-and-client-hints.html?lang=pt-BR){target=_blank} | Novo tópico. |
...
|  | [Diretivas da Política de segurança de conteúdo (CSP)](https://experienceleague.corp.adobe.com/docs/target-dev/developer/implementation/privacy/content-security-policy.html?lang=pt-BR){target=_blank} | Adição da seção de perguntas frequentes. |
...
|  | [Detalhes da versão da at.js](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html?lang=pt-BR){target=_blank} | Adição de informações sobre a versão 2.8.1 da at.js. |
...
| 21 de Janeiro | [Detalhes da versão da at.js](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html?lang=pt-BR){target=_blank} | Adição de informações sobre a versão 1.8.3 da at.js. |
| 19 de janeiro | [Atualização da at.js 1.*x* para a at.js 2.*x*](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions.html?lang=pt-BR){target=_blank} | Adição da seguinte seção: “A at.js 2.*x* não oferece suporte à criação de públicos-alvo usando parâmetros de vst.*” |
...
|  | [SDK da Web da Adobe Experience Platform](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/aep-web-sdk.html?lang=pt-BR){target=_blank} | Link adicionado ao tutorial com instruções para implementar a [!DNL Adobe Experience Cloud] com o SDK da Web. |

...
## Usar a lista [!UICONTROL Públicos-alvo] {#use-list}
...
* [!DNL Adobe Experience Platform]
  ...
  >
  >Os usuários devem ter o status [!UICONTROL Aprovador] ou superior em [!DNL Target] para configurar cartões [!DNL Target] [!UICONTROL Destinos] no AEP/RTCDP ([!DNL Real-time Customer Data Platform]).
  >
  >Para obter mais informações, consulte [Usar públicos do Adobe Experience Platform](#aep).

Públicos predefinidos, como &quot;[!UICONTROL Novos visitantes]&quot; e &quot;[!UICONTROL Visitantes recorrentes]&quot;, não podem ser renomeados.
...
* Se um público-alvo foi excluído em [!DNL Experience Cloud] ou [!DNL Adobe Experience Platform], é exibido um ícone de aviso na lista [!UICONTROL Público-alvo] e no seletor de público. Uma dica de ferramenta na interface do usuário [!DNL Target] também indica que o público-alvo foi excluído em [!DNL Experience Cloud] ou [!DNL Adobe Experience Platform].
...
Use o botão [!UICONTROL Filtros] para filtrar a lista [!UICONTROL Públicos-alvo] por origem: [!DNL Adobe Target], [!DNL Adobe Target Classic], [!DNL Experience Cloud] e [!DNL Adobe Experience Platform].

Opção ![Filtros na lista [!UICONTROL Públicos-alvo]](assets/filters.png)

Use a caixa [!UICONTROL Pesquisar públicos-alvo] para pesquisar sua lista [!UICONTROL Públicos-alvo]. Você pode procurar qualquer parte de um nome de público-alvo ou pode colocar uma determinada sequência de caracteres entre aspas.

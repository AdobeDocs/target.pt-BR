...
description: Saiba como usar o Analytics for [!DNL Target] (A4T). A integração A4T fornece acesso a relatórios robustos do Adobe Analytics para suas atividades de Adobe [!DNL Target] .

...
Os relatórios fornecem informações sobre o progresso e os resultados de sua [!DNL Adobe Target] atividades que ajudam a tomar decisões com base em seus dados. Os dados dos relatórios podem ajudá-lo a decidir quando encerrar uma atividade, mostrar a experiência de oferta vencedora e fornecer os insights ou os aprendizados necessários para determinar as próximas ações.
...
1. Clique na guia **[!UICONTROL Relatórios]**.
   ...
   * O [experiência vencedora projetada](/help/main/c-activities/automated-traffic-allocation/determine-winner.md) (se disponível).
...
1. (Opcional) [Baixe o relatório no formato CSV](/help/main/c-reports/downloading-data-in-csv-file.md#concept_3F276FF2BBB2499388F97451D6DE2E75) para análise no Excel e em outras ferramentas.
...
1. (Opcional) Clique nos ícones de **[!UICONTROL Exibição em tabela]** e **[!UICONTROL Exibição em gráfico]** para trocar entre os formatos de relatório.
   ...
   ![Ícones de exibição em Tabela e Gráfico](/help/main/c-reports/assets/table-and-graph-icons.png)

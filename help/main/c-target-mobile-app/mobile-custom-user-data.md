...
description: Saiba como enviar informações adicionais sobre a localização ou o usuário para o Adobe [!DNL Target] como pares de nome-valor para ajudar a criar públicos-alvo personalizados.
title: Como faço para enviar dados personalizados do usuário em um aplicativo iOS?

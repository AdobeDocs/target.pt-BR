...
Antes de começar a usar o [!DNL Adobe Target], pode ser útil obter uma visão geral de alto nível da solução. Neste capítulo, conheça os principais recursos da solução, os pontos de contato da marca nos quais você pode usá-la, as opções de implementação, os importantes recursos e fluxos de trabalho da interface do usuário, os recursos de governança e sua função no geral [!DNL Adobe Experience Cloud]. A menos que sejam descritos como recursos do [!DNL Adobe Target Premium], os itens descritos neste capítulo estão disponíveis com o [!DNL Adobe Target Premium] e o [!DNL Adobe Target Standard]. Para obter mais informações sobre o Target, consulte [Introdução ao Target](/help/main/c-intro/intro.md).

## Recursos e atividades

Teste e personalização são os dois grandes tipos de recursos que [!DNL Target] ofertas e que você pode usar ao criar uma &quot;atividade&quot; em [!DNL Target]. Você pode ver o termo &quot;teste&quot; usado alternadamente com &quot;otimização&quot; e &quot;personalização&quot; usado alternadamente com &quot;definição de metas&quot;.
...
O [!DNL Target] fornece três principais maneiras de configurar suas atividades de teste e personalização, o [!UICONTROL Visual Experience Composer] (VEC), o [!UICONTROL Experience Composer com base em formulário] e o [!UICONTROL Visual Experience Composer de SPA (aplicativo de página única)]. Ambos o orientam pelo processo de configuração da atividade em três etapas: definindo as experiências, selecionando ou definindo os públicos-alvo e selecionando as métricas de sucesso primárias e secundárias pelas quais você medirá os resultados de sua atividade.
...
* Opiniões que podem afetar negativamente a sua eficácia. Opinião de Pessoa Mais Alta Paga (HIPPO), atitudes, preconceitos. Por exemplo, o CEO deseja reduzir o tamanho da caixa de pesquisa para criar mais espaço em cada página. Devemos testar para garantir que não reduza o número de pesquisas.
* A atuação tem por base opiniões? Não gosto da aparência do teste. O cliente não vai gostar dessa experiência. Embora a intuição seja útil, o teste A/B tem provado, uma e outra vez, que nem sempre é pontual.
* Ou você tem uma mentalidade de otimização? Estou animado em ver qual experiência ganha. Temos opções suficientes para testar?

...
O [!DNL Target] fornece três principais maneiras de configurar suas atividades de teste e personalização, o [!UICONTROL Visual Experience Composer] (VEC), o [!UICONTROL Experience Composer baseado em formulário] e o [!UICONTROL Visual Experience Composer de SPA (aplicativo de página única)]. Ambos fornecem orientações sobre o processo de configuração da atividade em três etapas: definição das experiências, seleção ou definição dos públicos e seleção das métricas de sucesso primárias e secundárias pelas quais você medirá os resultados da atividade.
...
com [!UICONTROL Permissões da Empresa].

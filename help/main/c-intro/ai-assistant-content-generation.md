...
1. No [[!DNL Target] [!UICONTROL Visual Experience Composer]](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md) (VEC), clique no ícone **[!UICONTROL Mostrar Assistente de Conteúdo]** ( ![Mostrar ícone de Assistente de Conteúdo](/help/main/assets/icons/MagicWand.svg) ) no painel direito da interface do VEC.
...
1. Clique no ícone **[!UICONTROL Configurações de texto]** para especificar o tom e a estratégia de comunicação do texto.

   * **Estratégia de comunicação**: escolha o estilo de comunicação mais adequado para o texto gerado.

     As opções incluem: [!UICONTROL Nenhum], [!UICONTROL Urgente], [!UICONTROL FOMO] (Medo de Ficar de Fora), [!UICONTROL Prova Social], [!UICONTROL Escassez], [!UICONTROL Incentivo], [!UICONTROL Exclusividade], [!UICONTROL Gameificação], [!UICONTROL Informativo] e [!UICONTROL Educação e Insights].
...
1. (Opcional) Clique em **[!UICONTROL Brand Assets]** para carregar ou alternar ativos de marca para contexto de conteúdo adicional durante a geração.

1. Clique em **[!UICONTROL Gerar]** para criar uma lista de variações de texto.

   ![Variações de texto do Assistente de IA](/help/main/c-intro/assets/ai-variations-text.png)

1. Clique em **[!UICONTROL Aplicar]** para selecionar a variação de texto desejada.

   Você também pode clicar em **[!UICONTROL Visualizar]** para exibir diferentes variações. Clique na variação desejada e em **[!UICONTROL Selecionar]**.

   ![Assistente de IA com texto gerado](/help/main/c-intro/assets/ai-text-done.png)

1. (Condicional) Clique no ícone [!UICONTROL Desfazer] ( ![Ícone Desfazer](/help/main/assets/icons/Undo.svg) ) para reverter as alterações.
...
1. (Opcional) Forneça feedback ao [!DNL AI Assistant].
   ...
   * Clique no ícone [!UICONTROL Resultados do Relatório] ( ![Ícone de resultados do relatório](/help/main/assets/icons/Flag.svg) ) para relatar um problema ao [!DNL AI Assistant].

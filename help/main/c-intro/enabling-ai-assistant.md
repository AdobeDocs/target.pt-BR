...
## Habilitar Permissões de Usuário para o [!UICONTROL Assistente de IA]

Para usar o recurso [!UICONTROL Assistente de IA] no [!UICONTROL Target], as permissões de usuário individual devem ser habilitadas explicitamente.

{{permissions-update}}

1. Navegue até a guia **[!UICONTROL Administração]** em [!DNL Target].
1. No menu à esquerda, selecione **[!UICONTROL Usuários]**.
1. Localize o usuário que deseja gerenciar na lista ou use a barra de pesquisa para localizá-lo.
1. Passe o mouse sobre a coluna **[!UICONTROL Permissões de IA]** da pessoa à qual você deseja conceder acesso ao [!UICONTROL Assistente de IA do Target].

   Um pop-up de permissões é exibido.

   ![Configurações do Assistente de IA](/help/main/c-intro/assets/ai-pop-up2.png)

1. Use o botão de alternância para habilitar ou desabilitar a permissão **[!UICONTROL Assistente de IA de Destino]** para esse usuário.

   ![pop-up de permissões do Assistente de IA](/help/main/c-intro/assets/ai-pop-up.png)

   Após habilitado, o usuário tem acesso ao [!UICONTROL Assistente de IA] em [!DNL Target]. Somente usuários com esta permissão habilitada podem ver os recursos do [!UICONTROL Assistente de IA] na interface [!DNL Target]. Essa permissão garante que o acesso a ferramentas alimentadas por IA seja controlado e alinhado às políticas da organização.

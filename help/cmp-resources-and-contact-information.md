...
# Recursos e informações de contato{#resources-and-contact-information}
...
[Clique aqui para assistir a sessões anteriores ou para saber mais sobre as próximas sessões e informações](https://landing.adobe.com/acs/2018/na/adobe-target/registration.html) de registro.
...
|--- |--- |
| [dicas do at.js e visão geral](https://helpx.adobe.com/customer-care-office-hours/target/at-js-1x-Tips-and-Overview.html)<br>59:126 <br>de junho de 2019 | Você aprenderá:<ul><li>Benefícios do uso do at.js</li><li>Configurações do at.js</li><li>Manuseio de oscilação</li><li>Depuração do at.js</li><li>Problemas conhecidos</li><li>Perguntas frequentes</li></ul>Para obter mais informações, consulte [Como o at.js funciona](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md). |
| [Espaços de trabalho do Público alvo Premium](https://helpx.adobe.com/customer-care-office-hours/target/premium-workspaces.html)<br>27:494 <br>de setembro de 2018 | Você aprenderá:<ul><li>Criação de um espaço de trabalho (perfil de produto)</li><li>Criação de propriedades</li><li>Adicionar usuários</li><li>Atualização da implementação</li></ul>Para obter mais informações, consulte [Permissões de usuário do Enterprise](/help/administrating-target/c-user-management/property-channel/property-channel.md). |
...
Em caso de dúvidas, entre em contato com os especialistas da Adobe Target na [comunidade do Experience Cloud](https://forums.adobe.com/community/experience-cloud/marketing-cloud/target) ou entre em contato conosco no Twitter em [@AdobeExpCare](https://twitter.com/adobeexpcare).

No caso de problemas técnicos ou registro de um erro, entre em contato com o Atendimento ao cliente. Para entrar em contato com o Atendimento ao cliente por telefone, ligue para 1-800-497-0335. Os números gratuitos fora dos Estados Unidos podem ser encontrados na página [Números de telefone regionais do Atendimento ao cliente do Adobe Digital Marketing](https://helpx.adobe.com/contact/dma-external/DMACustomeCareRegionalPhoneNumbers.html). Quando for solicitado que você selecione uma opção para seu produto, pressione 3 para entrar em contato com a equipe do Target.
...
Para problemas de delivery de conteúdo, consulte [Solucionar problemas de delivery de conteúdo](/help/c-activities/c-troubleshooting-activities/content-trouble.md) para obter possíveis soluções e informações sobre solução de problemas.
...
[Atualização de produto de prioridade de Adobe](https://www.adobe.com/subscription/priority-product-update.html)
